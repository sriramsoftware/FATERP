<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Bay.ERP.Web.UI.LogInPage" %>
...
#container-header
{
    height: 70px; /*background-color: #3B5998;*/
...
<body>
    ...
    <div id="containerd">
        ...
        <div class="container">
            <section id="content">
	<form action="">
         <asp:Login ID="userLoginControl" runat="server" 
             OnLoggedIn="userLoginControl_LoggedIn" 
             FailureText="Your login attempt was not successful.">
                <InstructionTextStyle Font-Italic="True" ForeColor="Black" />
                
                <LayoutTemplate>
                	<div class="paddingtest">
                <h1>Log In - FAT ERP</h1>
                <div>
				<asp:TextBox ID="UserName" runat="server" ClientIDMode="Static" Font-Size="14"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                                ErrorMessage="User Name is required." ToolTip="User Name is required." ValidationGroup="Login1">*</asp:RequiredFieldValidator>
			</div>
			<div>
				<asp:TextBox ID="Password" runat="server" TextMode="Password" ClientIDMode="Static" Font-Size="14"> </asp:TextBox>
			...
			<div style="float:right;">
				    <asp:Button ID="LoginButton" runat="server" BackColor="#FFFBFF" BorderColor="#CCCCCC"
                                                ...
                                                Font-Size="1.8em" ForeColor="#284775" Text="Log In" ValidationGroup="Login1" />
			</div>
            </div>
                </LayoutTemplate>
			...
			<%--<h1>Login Form</h1>
			<div>
				<input type="text" placeholder="Username" required="" id="Daily Log " />
			</div>
			<div>
			...
			<div>
				...
				<a href="#">Register</a>
				 ...
				 <div class="button">
			<a href="http://fatbd.com/">FAT Ltd.</a>(<asp:Label ID="lblDBName" runat="server"></asp:Label>)
		</div><!-- button -->
        </form><!-- form -->
	</section>
            <!-- content -->
        ...
        <script type="text/javascript">
            ...
            //                document.getElementById("Password").value = "Year2012!";
        </script>
