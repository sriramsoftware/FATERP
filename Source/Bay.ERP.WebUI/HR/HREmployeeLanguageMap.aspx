...
<%@ Page Language="C#" MasterPageFile="~/Template/Employee.master" AutoEventWireup="true"
    CodeFile="HREmployeeLanguageMap.aspx.cs" Inherits="Bay.ERP.Web.UI.HREmployeeLanguageMapPage"
    Title="Bay's ERP" %>

<%@ Register Src="~/Controls/HR/HREmployeeLanguageMap.ascx" TagName="HREmployeeLanguageMapEntity"
    TagPrefix="uc" %>
...
<asp:Content ID="cntContent" ContentPlaceHolderID="cphContent" runat="Server">
    <div style="width: 1100px;">
        ...
        <div id="tab-contents">
            <uc:HREmployeeLanguageMapEntity ID="ucHREmployeeLanguageMapEntity" runat="server" />
            <br />
        </div>
    </div>
</asp:Content>
