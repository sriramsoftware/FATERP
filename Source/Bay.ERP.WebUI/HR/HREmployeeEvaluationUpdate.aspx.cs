...
{
    public partial class HREmployeeEvaluationUpdatePage : BasePage
    {
        #region Veriables
        ...
        public override string UniqueKey
        {
            get
            {
                return "HREmployeeEvaluationUpdateEntity_Page";
            }
        }
        ...
        public override string WebUserControlPaths
        {
            get
            {
                return "~/Controls/HREmployeeEvaluationUpdate.ascx;";
            }
        }
