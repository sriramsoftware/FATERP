...
namespace Bay.ERP.Web.UI.WebServices
{
    /// <summary>
    ...
    public class NotificationDispatcher : System.Web.Services.WebService
    {
        /// <summary>
        ...
        {
            return NotificationAdapterLive.Instance.GetMessage(userName);
        }
    }
}
