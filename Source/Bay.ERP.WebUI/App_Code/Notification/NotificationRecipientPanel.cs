...
namespace Bay.ERP.Web.UI.Notifciation
{
    ...
    /// </summary>
    public class NotificationRecipientPanel : NotificationRecipient
    {
        private ManualResetEvent messageEvent = new ManualResetEvent(false);
        private Queue<NotificationMessagePanel> messageQueue = new Queue<NotificationMessagePanel>();

        /// <summary>
        /// This method is called by a sender to send a message to this client.
        /// </summary>
        /// <param name="message">the new message</param>
        public void EnqueueMessage(NotificationMessagePanel message)
        {
            lock (messageQueue)
            {
        ...
        public NotificationMessagePanel DequeueMessage()
        {
