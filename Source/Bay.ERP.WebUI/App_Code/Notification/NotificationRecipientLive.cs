...
namespace Bay.ERP.Web.UI.Notifciation
{
    ...
    /// </summary>
    public class NotificationRecipientLive : NotificationRecipient
    {
        private ManualResetEvent messageEvent = new ManualResetEvent(false);
        private Queue<NotificationMessageLive> messageQueue = new Queue<NotificationMessageLive>();
        ...
        public NotificationMessageLive DequeueMessage()
        {
