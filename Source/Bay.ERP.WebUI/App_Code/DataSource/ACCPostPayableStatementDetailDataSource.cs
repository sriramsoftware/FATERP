...
{
    [DataObject(true)]
    public partial class ACCPostPayableStatementDetailDataSource
    {
        public Int32 totalRowCount = 0;

        public ACCPostPayableStatementDetailDataSource()
        {
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, true)]
        public IList<ACCPostPayableStatementDetailEntity> GetPagedData(Int32 startRowIndex, Int32 pageSize, String sortExpression, String filterExpression)
        {
            IList<ACCPostPayableStatementDetailEntity> aCCPostPayableStatementDetailEntityList = new List<ACCPostPayableStatementDetailEntity>();
            ...
            try
            {
                ...
                if (pageSize == 2147483647)
                {
                    ...
                    {
                        aCCPostPayableStatementDetailEntityList =  FCCACCPostPayableStatementDetail.GetFacadeCreate().GetIL(null, null, sortExpression, String.Empty, DatabaseOperationType.LoadWithSortExpression);
                    }
                    else
                    {
                        aCCPostPayableStatementDetailEntityList =  FCCACCPostPayableStatementDetail.GetFacadeCreate().GetIL(null, null, sortExpression, filterExpression, DatabaseOperationType.LoadWithFilterAndSortExpression);
                    }
                }
                else
                {
                    if (filterExpression.IsNullOrEmpty())
                    {
                        aCCPostPayableStatementDetailEntityList =  FCCACCPostPayableStatementDetail.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, String.Empty, DatabaseOperationType.LoadPagedWithSortExpression);
                    }
                    else
                    {
                        aCCPostPayableStatementDetailEntityList =  FCCACCPostPayableStatementDetail.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, filterExpression, DatabaseOperationType.LoadPagedWithFilterAndSortExpression);
                    }
                }
