...
{
    [DataObject(true)]
    public partial class PRMSupplierItemCategoryMapDataSource
    {
        public Int32 totalRowCount = 0;

        public PRMSupplierItemCategoryMapDataSource()
        {
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, true)]
        public IList<PRMSupplierItemCategoryMapEntity> GetPagedData(Int32 startRowIndex, Int32 pageSize, String sortExpression, String filterExpression)
        {
            IList<PRMSupplierItemCategoryMapEntity> pRMSupplierItemCategoryMapEntityList = new List<PRMSupplierItemCategoryMapEntity>();
            ...
            try
            {
                ...
                if (pageSize == 2147483647)
                {
                    ...
                    {
                        pRMSupplierItemCategoryMapEntityList =  FCCPRMSupplierItemCategoryMap.GetFacadeCreate().GetIL(null, null, sortExpression, String.Empty, DatabaseOperationType.LoadWithSortExpression);
                    }
                    else
                    {
                        pRMSupplierItemCategoryMapEntityList =  FCCPRMSupplierItemCategoryMap.GetFacadeCreate().GetIL(null, null, sortExpression, filterExpression, DatabaseOperationType.LoadWithFilterAndSortExpression);
                    }
                }
                else
                {
                    if (filterExpression.IsNullOrEmpty())
                    {
                        pRMSupplierItemCategoryMapEntityList =  FCCPRMSupplierItemCategoryMap.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, String.Empty, DatabaseOperationType.LoadPagedWithSortExpression);
                    }
                    else
                    {
                        pRMSupplierItemCategoryMapEntityList =  FCCPRMSupplierItemCategoryMap.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, filterExpression, DatabaseOperationType.LoadPagedWithFilterAndSortExpression);
                    }
                }
