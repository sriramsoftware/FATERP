...
{
    [DataObject(true)]
    public partial class ACBankAccountDepositItemDataSource
    {
        public Int32 totalRowCount = 0;

        public ACBankAccountDepositItemDataSource()
        {
        }
        ...
        [DataObjectMethod(DataObjectMethodType.Select, true)]
        public IList<ACBankAccountDepositItemEntity> GetPagedData(Int32 startRowIndex, Int32 pageSize, String sortExpression, String filterExpression)
        {
            IList<ACBankAccountDepositItemEntity> aCBankAccountDepositItemEntityList = new List<ACBankAccountDepositItemEntity>();
            ...
            try
            {
                ...
                if (pageSize == 2147483647)
                {
                    ...
                    {
                        aCBankAccountDepositItemEntityList =  FCCACBankAccountDepositItem.GetFacadeCreate().GetIL(null, null, sortExpression, String.Empty, DatabaseOperationType.LoadWithSortExpression);
                    }
                    else
                    {
                        aCBankAccountDepositItemEntityList =  FCCACBankAccountDepositItem.GetFacadeCreate().GetIL(null, null, sortExpression, filterExpression, DatabaseOperationType.LoadWithFilterAndSortExpression);
                    }
                }
                else
                {
                    if (filterExpression.IsNullOrEmpty())
                    {
                        aCBankAccountDepositItemEntityList =  FCCACBankAccountDepositItem.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, String.Empty, DatabaseOperationType.LoadPagedWithSortExpression);
                    }
                    else
                    {
                        aCBankAccountDepositItemEntityList =  FCCACBankAccountDepositItem.GetFacadeCreate().GetIL(startRowIndex, pageSize, sortExpression, filterExpression, DatabaseOperationType.LoadPagedWithFilterAndSortExpression);
                    }
                }
