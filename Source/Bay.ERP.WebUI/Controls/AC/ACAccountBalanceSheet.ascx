...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ACAccountBalanceSheet.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ACAccountBalanceSheetControl" %>
          <style type="text/css">
            ...
            <div class="TableRow" style="text-align: left;" runat="server">
             ...
             <div class="TableRow" style="width: 100;">
                ...
                <div class="TableFormContent">
                    <asp:TextBox ID="txtAsDate" runat="server" ClientIDMode="Static" CssClass="ktiDateTextBox"
                        ValidationGroup="ACJournalEntity" Width="230" />
                    <span class="RequiredField">*</span>
                </div>
                <div class="TableFormValidatorContent">
                    <asp:RequiredFieldValidator ID="rfvtxtAsDate" runat="server" ControlToValidate="txtAsDate"
                        ErrorMessage="Please Enter Transaction Date Time" ValidationGroup="ACJournalEntity"
                        EnableViewState="False" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revtxtAsDate" runat="server" ControlToValidate="txtAsDate"
