...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ACBankAccountPaymentDetailsWithApproval.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ACBankAccountPaymentDetailsWithApprovalControl" %>
...
<asp:UpdatePanel ID="upMauin" runat="server">
    <ContentTemplate>
    <asp:Label ID="lblPayment" EnableViewState="false" runat="server"></h1></asp:Label>
        <script type="text/javascript">
                    ...
                    <div class="TableRow" style="width: 100;">
                        ...
                        <div class="TableFormContent">
                            <asp:TextBox ID="txtReference" ClientIDMode="Static" CssClass="ktiTextBox" runat="server"
                                ReadOnly="true" ValidationGroup="ACBankAccountPaymentEntity" Width="150" />
                        </div>
                        <div class="TableFormValidatorContent">
                        </div>
                    </div>
        ...
        <div style="width:100%; border: 1px solid #C6C6C6;">
            ...
            <div style="clear:both;"></div>
                ...
                <div style="width:100%">
                        ...
                        <asp:ListView ID="lvACBankAccountPaymentItem" runat="server" OnItemCommand="lvACBankAccountPaymentItem_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr class="r">
                                    ...
                                    <td class="i">
                                       <b><%# Eval("AccountName")%></b>
                                    </td>
                                    <td class="i">
                                        <%# Bay.ERP.Web.UI.MiscUtil.NumericCommaSeperatedFormat((Decimal)Eval("Amount"))%>
                                    </td>
                                     <td class="i">
                                    ...
                                    <td class="i">
                                        ...
                                        <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                            ...
                                            UniqueKey="ACBankAccountPaymentDetailsWithApproval_lvACBankAccountPaymentItem_Edit_key" />
                                    </td>
                                    <td class="i">
                                        <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                            ...
                                            CommandArgument='<%#Eval("BankAccountPaymentItemID")%>' UniqueKey="ACBankAccountPaymentDetailsWithApproval_lvACBankAccountPaymentItem_Delete_key" />
                                    </td>
                                    <td class="rp">
                                        &nbsp;
                                    </td>
                    ...
                    <div style="font-size: 13px; font-weight: bold; color: Green; padding:10px 0px 0px 257px;" ID="dvTotalValue" runat="server" visible="true">
                Total Payment Value:
        ...
        <div style="padding-left: 250px;">
            <div class="TableRow" style="text-align: center;">
                <div class="TableFormLeble">
                    &nbsp;</div>
                <div class="TableFormContent">
                    <kti:SecureButton ID="btnSubmit" ValidationGroup="ACBankAccountPaymentEntity" OnClick="btnSave_Click"
                        runat="server" Text="Process Payment" UniqueKey="ACBankAccountPaymentControl_Submit_key" />
                    <%--  <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                        Text="Add New" UniqueKey="ACBankAccountPaymentControl_AddNew_key" />
                    <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                        UniqueKey="ACBankAccountPaymentControl_Clear_key" />--%>
                </div>
            </div>
        </div>
        <br />
