...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ACBankAccountDepositList.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ACBankAccountDepositListControl" %>
<asp:UpdatePanel ID="upMauin" runat="server">
    <ContentTemplate>
        <div>
            ...
            <div>
                <div class="lv-c">
                    <asp:ListView ID="lvACBankAccountDeposit" runat="server" DataSourceID="odsACBankAccountDeposit" OnItemDataBound="lvACBankAccountDeposit_ItemDataBound">
                        <LayoutTemplate>
                        ...
                        <ItemTemplate>
                            <tr class="r">
                                ...
                                <td class="i">
                                   <%# Eval("DepositDate") != null ? ((DateTime)Eval("DepositDate")).ToString("dd-MM-yyyy") : ""%>
                                </td>
                                  <td class="i">
                                    <%# Eval("PaidFromName")%>
                                </td>
                                <td class="i">
                                   <asp:HyperLink ID="hypReferenceLV"  CssClass="CommonLink" runat="server" Text='<%# Eval("Reference")%>'></asp:HyperLink>
                                </td>
                                <td class="i">
                                ...
                                <td class="i">
                                    <asp:Label runat="server" ToolTip='<%# Eval("Memo")%>' ID="a"><%# Eval("Memo") != String.Empty ? Eval("Memo").ToString().Substring(0, Math.Min(Eval("Memo").ToString().Length, 10)) : ""%></asp:Label>
                                </td>
                                <td class="i">
                                ...
                                <td class="i">
                                    <%# Eval("BankAccountDepositApprovalStatusName")%><br />
                                    <asp:HyperLink ID="lnkShowApprovalStatus" runat="server" Text="Approval Status" />
                                </td>
                                <td class="i">
                                <asp:HyperLink ID="hypDepositReport" runat="server" CssClass="CommonButtonLink"
                                    Text="Report" CommandName="Report" CommandArgument='<%#Eval("BankAccountDepositID")%>'></asp:HyperLink>
                            </td>
                                <td class="rp">
                                    &nbsp;
                                </td>
                ...
                <asp:ObjectDataSource ID="odsACBankAccountDeposit" runat="server" SelectMethod="GetPagedData"
                    SelectCountMethod="TotalRowCount" EnablePaging="true" MaximumRowsParameterName="pageSize"
                    StartRowIndexParameterName="startRowIndex" TypeName="Bay.ERP.Web.UI.ACBankAccountDeposit_DetailedDataSource"
                    SortParameterName="sortExpression" OnSelecting="odsACBankAccountDeposit_Selecting">
                    <SelectParameters>
