...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ACCApprovedPostPayableStatementDetailList.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ACCApprovedPostPayableStatementDetailListControl" %>
    ...
    <ContentTemplate>
        <div>
            ...
            <div class="listContentTitle">
                Approved Payable Statement Detail List
            </div>
            <div>
               <div>
                <div class="lv-c">
                    <asp:ListView ID="lvACCPostPayableStatementDetail" runat="server" DataSourceID="odsACCPostPayableStatementDetail" OnItemDataBound="lvACCPostPayableStatementDetail_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr class="r">
                                ...
                                <td class="i">
                                 <asp:HyperLink ID="hypPostPayableStatementDetailIDLV" runat="server" Text='<%# Eval("PostPayableStatementDetailID")%>'></asp:HyperLink>
                                </td>
                                <td class="i">
