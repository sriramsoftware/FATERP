...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ACCSecuredPostPayableStatementDetailList.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ACCSecuredPostPayableStatementDetailListControl" %>
    ...
    <ContentTemplate>
        <div>
            ...
            <div class="listContentTitle">
                Secured Payable Statement Detail List
            </div>
            <div>
                <div class="lv-c">
