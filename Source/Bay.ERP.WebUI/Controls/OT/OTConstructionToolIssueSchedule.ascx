...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OTConstructionToolIssueSchedule.ascx.cs"
    Inherits="Bay.ERP.Web.UI.OTConstructionToolIssueScheduleControl" %>
    ...
    <ContentTemplate>
     ...
     <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlConstructionToolID" CssClass="ktiSelect" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlConstructionToolID_SelectedIndexChanged"
