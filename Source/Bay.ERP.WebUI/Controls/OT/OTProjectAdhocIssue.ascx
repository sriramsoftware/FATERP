...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OTProjectAdhocIssue.ascx.cs"
    Inherits="Bay.ERP.Web.UI.OTProjectAdhocIssueControl" %>
        ...
        <div>
                    ...
                    <div class="TableRow" style="width: 100;">
                        ...
                        <div class="TableFormContent">
                            <asp:DropDownList ID="ddlProjectID" CssClass="ktiSelect" ClientIDMode="Static" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlProjectID_SelectedIndexChanged" runat="server" ValidationGroup="BDProjectHistoryEntity"
                                Width="236">
                            </asp:DropDownList>
                    ...
                    <div class="TableRow" style="width: 100;">
                        ...
                        <div class="TableFormValidatorContent">
                            <asp:RequiredFieldValidator ID="rfvSupervisorEmployeeID" runat="server" ControlToValidate="ddlSupervisorEmployeeID"
                                ErrorMessage="Please Select Supervisor Employee" ValidationGroup="OTIssueEntity"
                                EnableViewState="False" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableRow" style="width: 100;">
                        ...
                        <div class="TableFormValidatorContent">
                            <asp:RegularExpressionValidator ID="revActualStartDate" runat="server" ControlToValidate="txtActualStartDate"
                                Display="Dynamic" ErrorMessage="Invalide Format (Ex:07/25/2010 06:32)" ValidationExpression="^([0]\d|[1][0-2])\/([0-2]\d|[3][0-1])\/([2][01]|[1][6-9])\d{2}(\s([0-1]\d|[2][0-3])(\:[0-5]\d){1,2})?$"
                                ValidationGroup="OTIssueEntity"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="TableRow" style="width: 100;">
                ...
                <div class="TableRow" style="text-align: center;">
                    ...
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="OTIssueEntity" OnClick="btnSave_Click"
                            runat="server" Text="Add" UniqueKey="OTProjectAdhocIssueControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Post New" UniqueKey="OTProjectAdhocIssueControl_AddNew_key" />
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                            UniqueKey="OTProjectAdhocIssueControl_Clear_key" />
                        <br />
                        <br />
                        <br />
                        <br />
            ...
            <div style="float: left; padding-left: 20px; width: 400px;">
             ...
             <div style="float: left; padding-left: 20px; width: 400px;">
                ...
                <div>
                    <div class="lv-c" style="overflow: hidden;">
                        <asp:ListView ID="ListView1" runat="server" DataSourceID="odsOTIssue" OnItemDataBound="lvOTIssue_ItemDataBound">
                            <LayoutTemplate>
                                <table class="lv" cellpadding="0" cellspacing="0">
                                    <tr class="h">
                                        <td class="rp">
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetPagedData"
                        SelectCountMethod="TotalRowCount" EnablePaging="true" MaximumRowsParameterName="pageSize"
                        StartRowIndexParameterName="startRowIndex" TypeName="Bay.ERP.Web.UI.OTIssueDataSource"
                        SortParameterName="sortExpression" OnSelecting="odsOTIssue_Selecting">
                        <SelectParameters>
            ...
            <div class="TableRow" style="text-align: left;">
                <div class="TableFormLeble">
                  <asp:Button ID="btnSavePost" ValidationGroup="CMNERPCommentEntity" OnClick="btnSavePost_Click"
                        runat="server" Text="Post" UniqueKey="CMNERPCommentControl_Submit_key" /></div>
            </div>
            <br />
          <div style="width: 50%;">
