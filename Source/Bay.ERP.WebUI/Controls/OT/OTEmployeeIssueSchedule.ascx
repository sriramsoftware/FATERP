...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OTEmployeeIssueSchedule.ascx.cs"
    Inherits="Bay.ERP.Web.UI.OTEmployeeIssueScheduleControl" %>
    ...
    <ContentTemplate>
     ...
     <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlEmployeeID" CssClass="ktiSelect" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlEmployeeID_SelectedIndexChanged"
