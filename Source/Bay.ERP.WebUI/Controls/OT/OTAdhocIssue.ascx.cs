...
{
    public partial class OTAdhocIssueControl : BaseControl
    {
        #region Properties
        ...
        private void ValidateInput()
        {
            ...
            {
                String fe1 = OTIssueEntity.FLD_NAME_IssueStatusID + "<>" + MasterDataConstants.MDIssueStatus.COMPLETED;
                String fe2 = SqlExpressionBuilder.PrepareFilterExpression(OTIssueEntity.FLD_NAME_AssignedToEmployeeID, ddlAssignedToEmployeeID.SelectedValue.ToString(), SQLMatchType.Equal);
                String fe3 = OTIssueEntity.FLD_NAME_ExpectedStartDate + " between " + MiscUtil.ParseToDateTime(txtExpectedStartDate.Text.ToString()).ToShortDateString() + "and ";
            }
        }
        ...
        {
            String fe = SqlExpressionBuilder.PrepareFilterExpression(OTIssueEntity.FLD_NAME_IssueIdentityCategoryID, MasterDataConstants.IssueIdentityCategory.ADHOC_ISSUE.ToString(), SQLMatchType.Equal);
            String fe1 = SqlExpressionBuilder.PrepareFilterExpression(OTIssueEntity.FLD_NAME_CreatedByMemberID, CurrentMember.MemberID.ToString(), SQLMatchType.Equal);
