...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OTConsultantIssueSchedule.ascx.cs"
    Inherits="Bay.ERP.Web.UI.OTConsultantIssueScheduleControl" %>
    ...
    <ContentTemplate>
     ...
     <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlConsultantID" CssClass="ktiSelect" ClientIDMode="Static" AutoPostBack="true" OnSelectedIndexChanged="ddlConsultantID_SelectedIndexChanged"
