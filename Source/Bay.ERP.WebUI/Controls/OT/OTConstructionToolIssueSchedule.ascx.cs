...
{
    public partial class OTConstructionToolIssueScheduleControl : BaseControl
    {
        #region Properties
        ...
        {
            MiscUtil.PopulateCMConstructionToolDetail(ddlConstructionToolID, false);
        ...
        {
            if (ddlConstructionToolID.SelectedValue != "0" && ddlConstructionToolID.Items.Count > 0)
            {
                hfOverviewResourceID.Value = ddlConstructionToolID.SelectedValue.ToString();
            }
        }
        ...
        private void PrepareInitialView()
        {
            ...
            hfOverviewResourceCategoryID.Value = MasterDataConstants.ResourceCategory.TOOL.ToString();
        ...
        protected void ddlConstructionToolID_SelectedIndexChanged(object sender, EventArgs e)
        {
            SetResourceIDByDropdown();
        }
