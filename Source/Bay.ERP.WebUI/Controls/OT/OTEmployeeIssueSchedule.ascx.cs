...
{
    public partial class OTEmployeeIssueScheduleControl : BaseControl
    {
        #region Properties
        ...
        {
            if (ddlEmployeeID.SelectedValue != "0" && ddlEmployeeID.Items.Count > 0)
            {
                hfOverviewResourceID.Value = ddlEmployeeID.SelectedValue.ToString();
            }
        }
        ...
        private void PrepareInitialView()
        {
            ...
            hfOverviewResourceCategoryID.Value = MasterDataConstants.ResourceCategory.EMPLOYEE.ToString();
