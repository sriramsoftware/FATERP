...
{
    public partial class OTContractorIssueScheduleControl : BaseControl
    {
        #region Properties
        ...
        {
            if (ddlContractorID.SelectedValue != "0" && ddlContractorID.Items.Count > 0)
            {
                hfOverviewResourceID.Value = ddlContractorID.SelectedValue.ToString();
            }
        }
        ...
        private void PrepareInitialView()
        {
            ...
            hfOverviewResourceCategoryID.Value = MasterDataConstants.ResourceCategory.CONTRACTOR.ToString();
        ...
        protected void ddlContractorID_SelectedIndexChanged(object sender, EventArgs e)
        {
            SetResourceIDByDropdown();
        }
