...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PRMWorkOrderPaymentTerm.ascx.cs"
    Inherits="Bay.ERP.Web.UI.PRMWorkOrderPaymentTermControl" %>
<style type="text/css">
    div.demo
    {
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:TextBox ID="txtCompletionNote" ClientIDMode="Static" CssClass="ktiTextBox" runat="server"
                            ...
                            <span><asp:CheckBox ID="chbxSecurityMoney" runat="server" Text="Security Money" AutoPostBack="true" oncheckedchanged="chbxSecurityMoney_CheckedChanged"  /></span>
                    </div>
                    <div class="TableFormValidatorContent">
                    </div>
                </div>
                    ...
                    <div class="TableFormContent">
                        ...
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                         ...
                         <kti:SecureButton ID="btnInitiateApprovalProcess" ValidationGroup="none" OnClick="btnInitiateApprovalProcess_Click"                                
                                runat="server" Text="Submit for Approval" UniqueKey="PRMWorkOrderPaymentTermControl_InitiateApprovalProcess_key" />
                    </div>
                </div>
                <div class="TableRow" style="width: 100;">
                    <div class="TableFormLeble" style="text-align: left;">
                    ...
                    <asp:HyperLink ID="hypWorkOrderItem"  CssClass="hypTableFormLeble" runat="server" Text="Work Order Item"></asp:HyperLink>&nbsp;|
                        <asp:HyperLink ID="hypReport" runat="server" CssClass="hypTableFormLeble" Text="Report"></asp:HyperLink>
                        </div>
                    </div>
                </div>
            </asp:Panel>
