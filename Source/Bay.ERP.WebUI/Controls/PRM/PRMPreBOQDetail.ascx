...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PRMPreBOQDetail.ascx.cs"
    Inherits="Bay.ERP.Web.UI.PRMPreBOQDetailControl" %>
<asp:UpdatePanel ID="upMauin" runat="server">
    ...
    <ContentTemplate>
        ...
        <div class="lv-c">
            <asp:ListView ID="lvPRMPreBOQDetail" runat="server" DataSourceID="odsPRMPreBOQDetail_Custom" OnItemDataBound="lvPRMPreBOQDetail_ItemDataBound"
                        ...
                        <tr>
                            <td colspan="100%">
                                <div class="lv-FooterContainer">
                                    <div class="lv-Footer">
                                        <asp:DataPager ID="dpListView" runat="server" PageSize="20" OnPagePropertiesChanged="lvPRMPreBOQDetail_PagePropertiesChanged">
                                            <Fields>
                ...
                <ItemTemplate>
                    <tr class="r">
                        ...
                        <td class="i">
                            <asp:TextBox ID="txtRemarksLV" runat="server" Text='<%# Eval("Remarks")%>' CssClass="ktiTextBoxListview" TextMode="MultiLine"></asp:TextBox>
                        </td>
                       <td class="i">
                        ...
                        <td class="i" style="display:none;">
                            <asp:Label ID="lblBrandID" runat="server" Text='<%# Eval("BrandID")%>'></asp:Label>
                             ...
                             <asp:Label ID="lblPreBOQDetailIDLV" runat="server" Text='<%# Eval("PreBOQDetailID")%>'></asp:Label>
                        </td>
                        <td class="rp">
                            &nbsp;
                        </td>
        ...
        <div style="text-align: right; padding-top: 5px;">
            <kti:SecureButton ID="btnUpdate" OnClick="btnUpdate_Click" runat="server" Text="Save"
                UniqueKey="PRMPreBOQDetailControl_Update_key" />
        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="TableRow" style="width: 100;">
                                                ...
                                                <div class="TableFormContent">
                                                    ...
                                                    <kti:SecureButton ID="btnUpdatePopup" runat="server" Text="Update" OnClick="lnkSavePopup_Click" UniqueKey="PRMPreBOQDetailControl_UpdatePopup_key"/>
                                                    <kti:SecureButton ID="btnCancel" runat="server" Text="Cancel" UniqueKey="PRMPreBOQDetailControl_CancelPopup_key" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="page-content">
                                        ...
                                        <div>
                                            ...
                                            <div class="lv-c" style="max-height: 200px; overflow-x:hidden;">
                                                <asp:ListView ID="lvPRMPreBOQFloorDetail" runat="server" DataSourceID="odsPRMPreBOQFloorDetail">
                                                    <LayoutTemplate>
                                                        <table class="lv" cellpadding="0" cellspacing="0">
                                                            <tr class="h">
                                                                <td class="rp">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr class="r">
                                                            ...
                                                            <td class="i" style="display: none;">
                                                                <asp:Label ID="lblPreBOQFloorDetailIDLV" runat="server" Text='<%# Eval("PreBOQFloorDetailID")%>'></asp:Label>
                                                            </td>
                                                            <td class="i">
                                            ...
                                            <asp:ObjectDataSource ID="odsPRMPreBOQFloorDetail" runat="server" SelectMethod="GetPagedData"
                                                SelectCountMethod="TotalRowCount" EnablePaging="true" MaximumRowsParameterName="pageSize"
                                                StartRowIndexParameterName="startRowIndex" TypeName="Bay.ERP.Web.UI.PRMPreBOQFloorDetail_DetailedDataSource"
