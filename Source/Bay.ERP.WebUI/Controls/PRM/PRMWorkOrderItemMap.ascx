...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PRMWorkOrderItemMap.ascx.cs"
    Inherits="Bay.ERP.Web.UI.PRMWorkOrderItemMapControl" %>
        ...
        <div>
            <div>
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlRequisitionID" CssClass="ktiSelect" ClientIDMode="Static" Enabled="true"
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent waterMarkContainer">
                        ...
                        <asp:TextBox ID="txtRequiredQty" CssClass="ktiDecimalTextBox" ClientIDMode="Static"
                            ReadOnly="true" ToolTip="Only Admin Group Can Change The Value." runat="server"
                            ValidationGroup="PRMWorkOrderItemMapEntity" Width="210" />
                        <span class="RequiredField">*<kti:SecureButton ID="btnRequiredQtyEdit" OnClick="btnRequiredQtyEdit_Click"
                            runat="server" Text="Edit" UniqueKey="PRMWorkOrderItemMapControl_EditRequiredQty_key" /></span>
                    </div>
                    <div class="TableFormValidatorContent">
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:TextBox ID="txtItemDescription" ClientIDMode="Static" CssClass="ktiTextBox"
                            runat="server" TextMode="SingleLine" ToolTip="Enter Item Description Here!!!"
                ...
                <div class="TableRow" style="text-align: center;">
                    ...
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="PRMWorkOrderItemMapEntity" OnClick="btnSave_Click"
                            runat="server" Text="Add" UniqueKey="PRMWorkOrderItemMapControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Add New" UniqueKey="PRMWorkOrderItemMapControl_AddNew_key" />
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                            UniqueKey="PRMWorkOrderItemMapControl_Clear_key" />
                    </div>
                </div>
                <br />
                ...
                <div>
                    <div class="lv-c">
                        <asp:ListView ID="lvPRMWorkOrderItemMap" runat="server" DataSourceID="odsPRMWorkOrderItemMap" OnItemDataBound="lvPRMWorkOrderItemMap_ItemDataBound"
                            ...
                            <ItemTemplate>
                                <tr class="r">
                                    ...
                                    <td class="i">
                                    <asp:HyperLink ID="hypRequisitionNoLV" runat="server" Text='<%# Eval("RequisitionNo")%>'></asp:HyperLink>
                                    </td>
                                    <td class="i">
                                       <asp:Label ID="lblItemNameLV" runat="server"  Text='<%# Eval("ItemName")%>'></asp:Label>
                                        <br />
                                        (<%# Eval("UnitName")%>)
                                    </td>
                                    <td class="i">
                                    ...
                                    <td class="i" style="display: none;">
                                        <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                            ...
                                            UniqueKey="PRMWorkOrderItemMap_lvPRMWorkOrderItemMap_Edit_key" />
                                    </td>
                                    <td class="i">
                                        <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                            ...
                                            CommandArgument='<%#Eval("WorkOrderItemMapID")%>' UniqueKey="PRMWorkOrderItemMap_lvPRMWorkOrderItemMap_Delete_key" />
                                    </td>
                                    <td class="i">
                                        <kti:SecureLinkButton ID="lnkBtnItemDetail" runat="server" CssClass="CommonButtonLink"
                                            ...
                                            CommandArgument='<%#Eval("WorkOrderItemMapID")%>' UniqueKey="PRMWorkOrderItemMap_lvPRMWorkOrderItemMap_Detail_key" />
                                        <br />
                                        ...
                                        <br />
                                        <asp:LinkButton ID="lnkBtnMakeEvent" runat="server" CssClass="CommonButtonLink"
                                                                    Text="Make Event" CommandName="Event" CommandArgument='<%#Eval("WorkOrderItemMapID")%>'/>
                                    </td>
                                    <td class="rp">
                                        &nbsp;
                                    </td>
                            ...
                            <AlternatingItemTemplate>
                                <tr class="ar">
                                    ...
                                    <td class="i">
                                        <asp:Label ID="lblItemNameLV" runat="server"  Text='<%# Eval("ItemName")%>'></asp:Label><br />
                                        (<%# Eval("UnitName")%>)
                                    </td>
                                    <td class="i">
                                        <%# Eval("RequiredQty")%>
                                    ...
                                    <td class="i">
                                        ...
                                        <asp:LinkButton ID="lnkRequisitionFloorDetail" runat="server" CssClass="CommonButtonLink"
                                            ToolTip="Please Click Here To Modify The Total Qty Floor Wise!" Text="Floor Wise Qty"
                                            CommandName="FloorWiseRateAndQty" CommandArgument='<%#Eval("WorkOrderItemMapID")%>' /><br />
                                        <asp:LinkButton ID="lnkBtnMakeEvent" runat="server" CssClass="CommonButtonLink"
                                                                    Text="Make Event" CommandName="Event" CommandArgument='<%#Eval("WorkOrderItemMapID")%>'/>
                                    </td>
                                    <td class="rp">
                ...
                <div class="TableFormContent" style="padding-top: 10px;">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                            <asp:Button ID="btnCreateWorkOrderDetail" ValidationGroup="none"
                                    OnClick="btnCreateWorkOrderDetail_Click"
                                    runat="server" Text="WO Details" />
                                <%--<kti:SecureButton ID="btnInitiateApprovalProcess" ValidationGroup="none" OnClick="btnInitiateApprovalProcess_Click" Visible="false"
                                runat="server" Text="Submit for Approval" UniqueKey="PRMWorkOrderItemMapControl_InitiateApprovalProcess_key" />--%>
                                <kti:SecureButton ID="btnWorkOrderPaymentTerm" ValidationGroup="none" OnClick="btnWorkOrderPaymentTerm_Click"
                                    runat="server" Text="Payment Term" UniqueKey="PRMWorkOrderItemMapControl_PaymentTerm_key" />
                            </td>
                        </tr>
                    </table>
                </div>
                                        ...
                                        <div class="TableRow" style="width: 100;">
                                            ...
                                            <div class="TableFormContent">
                                                ...
                                                <kti:SecureButton ID="btnAddNewPopup" Visible="false" OnClick="btnAddNewPopup_Click"
                                                    runat="server" Text="Add New" UniqueKey="PRMWorkOrderItemDetailControl_AddNewPopUp_key" />
                                                <kti:SecureButton ID="btnClearPopup" OnClick="btnClearPopup_Click" runat="server"
                                                    Text="Clear" UniqueKey="PRMWorkOrderItemDetailControl_ClearPopup_key" />
                                                <kti:SecureButton ID="btnCancel" runat="server" Text="Cancel" UniqueKey="PRMWorkOrderItemDetailControl_CancelPopup_key" />
                                            </div>
                                        </div>
                                        <div>
                                            <div class="lv-c">
