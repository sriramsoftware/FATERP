...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SiteCMMeasurementBook.ascx.cs"
    Inherits="Bay.ERP.Web.UI.SiteCMMeasurementBookControl" %>
                ...
                <div class="TableRow" style="text-align: center;">
                    ...
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="CMMeasurementBookEntity" OnClick="btnSave_Click"
                            runat="server" Text="Add" UniqueKey="SiteCMMeasurementBookControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Add New" UniqueKey="SiteCMMeasurementBookControl_AddNew_key" />
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                            UniqueKey="SiteCMMeasurementBookControl_Clear_key" />
                    </div>
                </div>
                <br />
            </asp:Panel>
                                ...
                                <tr class="h">
                                    ...
                                    <td class="hi">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByProjectCode"
                                            CommandName="Sort" Text="Project Code" CommandArgument="CMMeasurementBook.ProjectCode" />
                                    </td>
                                    <td class="hi">
                            ...
                            <tr class="r">
                                ...
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                        ...
                                        UniqueKey="SiteCMMeasurementBook_lvCMMeasurementBook_Edit_key" />
                                </td>
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                        Text="Delete" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure to delete Measurement Book?')"
                                        CommandArgument='<%#Eval("MeasurementBookID")%>' UniqueKey="SiteCMMeasurementBook_lvCMMeasurementBook_Delete_key" />
                                </td>
                                <td class="rp">
                                    &nbsp;
                                </td>
