...
{
    public partial class REQRequisitionControl : BaseControl
    {       
        #region Properties
        ...
        {
            BuildDropDownList();
            //GetNextREQRequisitionNo(); Sequence Implemented Instead of this method.

            txtRequisitionNo.Text = MasterDataConstants.AutoAssigned.DEFAULT_AUTO_ASSIGNED;
            ...
            chkIsCashPayment.Checked = false;
            chkIsRCS.Checked = false;
        ...
        private void PrepareEditView()
        {
            ...
            if (!rEQRequisitionEntity.IsNew)
            {
                ...
                btnSubmit.Text = "Update & Edit Details";
                chkIsCashPayment.Checked = rEQRequisitionEntity.IsCashPayment;
                chkIsRCS.Checked = rEQRequisitionEntity.IsRCS;
        ...
        private REQRequisitionEntity BuildREQRequisitionEntity()
        {
            ...
            BDProjectEntity _bDProjectEntity = FCCBDProject.GetFacadeCreate().GetByID(rEQRequisitionEntity.ProjectID);

            if (_bDProjectEntity != null && txtRequisitionNo.Text.ToString()==MasterDataConstants.AutoAssigned.DEFAULT_AUTO_ASSIGNED)
            {
                rEQRequisitionEntity.RequisitionNo = _bDProjectEntity.ProjectCode;
            }

            else if (_bDProjectEntity != null && txtRequisitionNo.Text.ToString() != MasterDataConstants.AutoAssigned.DEFAULT_AUTO_ASSIGNED)
            {
                rEQRequisitionEntity.RequisitionNo = txtRequisitionNo.Text.ToString();
            }
            ...
            rEQRequisitionEntity.IsCashPayment = chkIsCashPayment.Checked;
            rEQRequisitionEntity.IsAccountsMadePayment = false;
            rEQRequisitionEntity.IsRCS = chkIsRCS.Checked;
        ...
        //            if (requisitonList != null && requisitonList.Count > 0)
        //            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                PrepareEditView();
               //Activity Log
               // base.LogActivity("Visiting the Requisition Page...", true);
            }
        }
