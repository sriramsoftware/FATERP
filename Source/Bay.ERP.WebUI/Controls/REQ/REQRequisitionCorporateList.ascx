...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="REQRequisitionCorporateList.ascx.cs"
    Inherits="Bay.ERP.Web.UI.REQRequisitionCorporateListControl" %>
                        ...
                        <tr class="r">
                            ...
                            <td class="i">
                                <asp:HyperLink ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink" Text="Edit"
                                    CommandName="EditItem" CommandArgument='<%#Eval("RequisitionID")%>' UniqueKey="REQRequisitionCorporateList_lvREQRequisition_Edit_key"></asp:HyperLink>
                            </td>
                            <td class="i">
                                <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                    Text="Delete" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure to delete Requisition?')"
                                    CommandArgument='<%#Eval("RequisitionID")%>' UniqueKey="REQRequisitionCorporateList_lvREQRequisition_Delete_key" />
                            </td>
                            <td class="i" style="display:none;">
                                <asp:HyperLink ID="hypRequisitionReport" runat="server" CssClass="CommonButtonLink"
                                    ...
                                    UniqueKey="REQRequisitionCorporateList_lvREQRequisition_RequisitionReport_key"></asp:HyperLink>
                            </td>
                            <td class="i">
                                <asp:HyperLink ID="hypApproval" runat="server" CssClass="CommonButtonLink"
                                    Text="Setup Approval" CommandName="Approval" CommandArgument='<%#Eval("RequisitionID")%>'
                                    UniqueKey="REQRequisitionCorporateList_lvREQRequisition_Approval_key"></asp:HyperLink>
                            </td>
                            <td class="rp">
                                &nbsp;
                            </td>
