...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="REQRequisitionPrintList.ascx.cs"
    Inherits="Bay.ERP.Web.UI.REQRequisitionPrintListControl" %>
                        ...
                        <tr class="r">
                            ...
                            <td class="i" style="display:none;">
                                <asp:HyperLink ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink" Text="Edit"
                                    CommandName="EditItem" CommandArgument='<%#Eval("RequisitionID")%>' UniqueKey="REQRequisitionPrintList_lvREQRequisition_Edit_key"></asp:HyperLink>
                            </td>
                            <td class="i" style="display:none;">
                                <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                    Text="Delete" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure to delete Requisition?')"
                                    CommandArgument='<%#Eval("RequisitionID")%>' UniqueKey="REQRequisitionPrintList_lvREQRequisition_Delete_key" />
                            </td>
                            <td class="i">
                                <asp:HyperLink ID="hypRequisitionReport" runat="server" CssClass="CommonButtonLink" Text="Report"
                                    CommandName="RequisitionReport" CommandArgument='<%#Eval("RequisitionID")%>' UniqueKey="REQRequisitionPrintList_lvREQRequisition_RequisitionReport_key"></asp:HyperLink>
                            </td>
                            <td class="rp">
                                &nbsp;
                            </td>
