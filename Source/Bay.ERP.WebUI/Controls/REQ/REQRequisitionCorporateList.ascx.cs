...
{
    public partial class REQRequisitionCorporateListControl : ProjectBaseControl
    {       
        #region Properties
        ...
        protected void lvREQRequisition_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
                ...
                HyperLink hypApproval = (HyperLink)e.Item.FindControl("hypRequisitionReport");
                ...
                hypEdit.NavigateUrl = UrlHelper.BuildSecureUrl("~/REQ/REQRequisitionCorporate.aspx", string.Empty, "do", "Edit", UrlConstants.REQUISITION_ID, ent.RequisitionID.ToString()).ToString();
                hypRequisition.NavigateUrl = UrlHelper.BuildSecureUrl("~/REQ/REQRequisitionItemCorporate.aspx", string.Empty, UrlConstants.OVERVIEW_PROJECT_ID, this.OverviewProjectID.ToString(), REQRequisitionEntity.FLD_NAME_RequisitionID, ent.RequisitionID.ToString(), REQRequisitionEntity.FLD_NAME_RequisitionNo, ent.RequisitionNo.ToString()).ToString();

                //Approval process need to know detail about this link from Reza vaiya.
                hypApproval.NavigateUrl = UrlHelper.BuildSecureUrl("~/REQ/REQRequisition.aspx", string.Empty, "do", "Edit", UrlConstants.REQUISITION_ID, ent.RequisitionID.ToString()).ToString();

                hypEdit.Target = "_blank";
                hypRequisitionReport.Target = "_blank";
                hypApproval.Target = "_blank";
            }
        }
