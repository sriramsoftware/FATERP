...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CMConsultantAssignedWorkAreaStandalone.ascx.cs"
    Inherits="Bay.ERP.Web.UI.CMConsultantAssignedWorkAreaStandaloneControl" %>
    ...
    <ContentTemplate>
        ...
        <div>
            <asp:Panel ID="pnlEditor" runat="server" CssClass="pnlEditor">
                ...
                <div class="TableRow" style="width: 100;">
                    <div class="TableFormLeble" style="text-align: left;">
                    <asp:HyperLink CssClass="hypTableFormLeble" ID="hypConsultant" runat="server" Text="Consultant" NavigateUrl="~/CM/CMConsultant.aspx" Target="_blank"></asp:HyperLink>
                        &nbsp;:
                    </div>
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlConsultantID" CssClass="ktiSelect" ClientIDMode="Static" OnSelectedIndexChanged="ddlConsultantID_SelectedIndexChanged" AutoPostBack="true"
                            runat="server" ValidationGroup="CMConsultantAssignedWorkAreaEntity" Width="236">
                        </asp:DropDownList>
                        <span class="RequiredField">*</span>
                    </div>
                    <div class="TableFormValidatorContent">
                        <asp:RequiredFieldValidator ID="rfvddlConsultantID" runat="server" ControlToValidate="ddlConsultantID"
                            ErrorMessage="Please Select Consultant" ValidationGroup="CMConsultantAssignedWorkAreaEntity"
                            EnableViewState="False" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="TableRow" style="width: 100;">
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:TextBox ID="txtRemarks" ClientIDMode="Static" CssClass="ktiTextArea" runat="server" TextMode="MultiLine"
                            ValidationGroup="CMConsultantAssignedWorkAreaEntity" Width="390" Height="105" />
                    </div>
                    <div class="TableFormValidatorContent">
                    </div>
                </div>
                <div class="TableRow" style="text-align: center;">
                    ...
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="CMConsultantAssignedWorkAreaEntity"
                            OnClick="btnSave_Click" runat="server" Text="Add" UniqueKey="CMConsultantAssignedWorkAreaStandaloneControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Add New" UniqueKey="CMConsultantAssignedWorkAreaControl_AddNew_key" />
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                            UniqueKey="CMConsultantAssignedWorkAreaStandaloneControl_Clear_key" />
                    </div>
                </div>
                <br />
            </asp:Panel>
                            ...
                            <tr class="r">
                                ...
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                        ...
                                        UniqueKey="CMConsultantAssignedWorkAreaStandalone_lvCMConsultantAssignedWorkArea_Edit_key" />
                                </td>
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                        ...
                                        CommandArgument='<%#Eval("ConsultantAssignedWorkAreaID")%>' UniqueKey="CMConsultantAssignedWorkAreaStandalone_lvCMConsultantAssignedWorkArea_Delete_key" />
                                </td>
                                <td class="rp">
                                    &nbsp;
                                </td>
