...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CMConsultantAddressInfo.ascx.cs"
    Inherits="Bay.ERP.Web.UI.CMConsultantAddressInfoControl" %>
        ...
        <asp:Panel ID="pnlCPEContent" runat="server" CssClass="pnlCPEContent">
            <div id="divCollapsControl" class="divCollapsControl">
                ...
                <div style="float: left; padding-left: 3px;">
                    <asp:Label ID="lvlCollapsText" runat="server" Text="Add/Edit Consultant Address Info"></asp:Label>
                </div>
            ...
            <asp:Panel ID="pnlEditor" runat="server" CssClass="pnlEditor">
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlAddressTypeID" CssClass="ktiSelect" ClientIDMode="Static"
                            runat="server" ValidationGroup="CMConsultantAddressInfoEntity" Width="236">
                        </asp:DropDownList>
                        <span class="RequiredField">*</span>
                    </div>
                    <div class="TableFormValidatorContent">
                        <asp:RequiredFieldValidator ID="rfvAddressTypeID" runat="server" ControlToValidate="ddlAddressTypeID"
                            ErrorMessage="Please Select Address Type" ValidationGroup="CMConsultantAddressInfoEntity"
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlCountryID" CssClass="ktiSelect" ClientIDMode="Static" runat="server"
                            AutoPostBack="true" ValidationGroup="CMConsultantAddressInfoEntity" Width="236"
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent">
                        <asp:DropDownList ID="ddlCityID" CssClass="ktiSelect" ClientIDMode="Static" runat="server"
                            ValidationGroup="CMConsultantAddressInfoEntity" Width="236">
                        </asp:DropDownList>
                    </div>
                    <div class="TableFormValidatorContent">
                    </div>
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormContent waterMarkContainer">
                        ...
                        <asp:TextBox ID="txtAddressLine1" ClientIDMode="Static" CssClass="ktiTextBox" runat="server"
                            ValidationGroup="CMConsultantAddressInfoEntity" Width="230" />
                        <span class="RequiredField">*</span>
                    </div>
                    <div class="TableFormValidatorContent">
                        <asp:RequiredFieldValidator ID="rfvAddressLine1" runat="server" ControlToValidate="txtAddressLine1"
                            ErrorMessage="Please Enter Address Line1" ValidationGroup="CMConsultantAddressInfoEntity"
                            EnableViewState="False" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="TableRow" style="width: 100;">
                ...
                <div class="TableRow" style="width: 100;">
                    ...
                    <div class="TableFormValidatorContent">
                        <asp:RegularExpressionValidator ID="revPhone" runat="server" ControlToValidate="txtPhone"
                            Display="Dynamic" EnableViewState="true" ValidationGroup="CMConsultantAddressInfoEntity"></asp:RegularExpressionValidator>
                    </div>
                </div>
                <div class="TableRow" style="width: 100;">
                    <div class="TableFormLeble" style="text-align: left;">
                ...
                <div class="TableRow" style="text-align: center;">
                    <div class="TableFormLeble">
                        &nbsp;</div>
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="CMConsultantAddressInfoEntity"
                            OnClick="btnSave_Click" runat="server" Text="Add" UniqueKey="CMConsultantAddressInfoControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Add New" UniqueKey="CMConsultantAddressInfoControl_AddNew_key" />
                        <kti:SecureButton ID="btnClear" OnClick="btnClear_Click" runat="server" Text="Clear"
                            UniqueKey="CMConsultantAddressInfoControl_Clear_key" />
                    </div>
                </div>
                <br />
            </asp:Panel>
            <div class="listContentTitle">
                Artist Address Info List
            </div>
            <div>
                <div class="lv-c">
                    <asp:ListView ID="lvCMConsultantAddressInfo" runat="server" DataSourceID="odsCMConsultantAddressInfo"
                        OnItemCommand="lvCMConsultantAddressInfo_ItemCommand">
                        <LayoutTemplate>
                                ...
                                <tr class="h">
                                    ...
                                    <td class="hi">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByAddressLine1"
                                            CommandName="Sort" Text="Address Line1" CommandArgument="CMConsultantAddressInfo.AddressLine1" />
                                    </td>
                                    <td class="hi" style="display: none;">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByAddressLine2"
                                            CommandName="Sort" Text="Address Line2" CommandArgument="CMConsultantAddressInfo.AddressLine2" />
                                    </td>
                                    <td class="hi">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByPhone"
                                            CommandName="Sort" Text="Phone" CommandArgument="CMConsultantAddressInfo.Phone" />
                                    </td>
                                    <td class="hi">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByFax"
                                            CommandName="Sort" Text="Fax" CommandArgument="CMConsultantAddressInfo.Fax" />
                                    </td>
                                    <td class="hi" style="display: none;">
                                        <asp:LinkButton CssClass="ktiListViewHeaderText" runat="server" ID="lnkSortByZipCode"
                                            CommandName="Sort" Text="Zip Code" CommandArgument="CMConsultantAddressInfo.ZipCode" />
                                    </td>
                                    <td class="his">
                                        EDIT
                                    </td>
                            ...
                            <tr class="r">
                                ...
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                        Text="Edit" CommandName="EditItem" CommandArgument='<%#Eval("ConsultantAddressInfoID")%>'
                                        UniqueKey="CMConsultantAddressInfo_lvCMConsultantAddressInfo_Edit_key" />
                                </td>
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                        Text="Delete" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure to delete Consultant Address Info?')"
                                        CommandArgument='<%#Eval("ConsultantAddressInfoID")%>' UniqueKey="CMConsultantAddressInfo_lvCMConsultantAddressInfo_Delete_key" />
                                </td>
                                <td class="rp">
                                    &nbsp;
                                </td>
                ...
                <asp:ObjectDataSource ID="odsCMConsultantAddressInfo" runat="server" SelectMethod="GetPagedData"
                    SelectCountMethod="TotalRowCount" EnablePaging="true" MaximumRowsParameterName="pageSize"
                    StartRowIndexParameterName="startRowIndex" TypeName="Bay.ERP.Web.UI.CMConsultantAddressInfo_DetailedDataSource"
                    SortParameterName="sortExpression" OnSelecting="odsCMConsultantAddressInfo_Selecting">
                    <SelectParameters>
