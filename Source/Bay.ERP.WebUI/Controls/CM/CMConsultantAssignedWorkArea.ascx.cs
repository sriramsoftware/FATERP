...
{
    public partial class CMConsultantAssignedWorkAreaControl : ConsultantBaseControl
    {       
        #region Properties
        ...
        private void BuildDropDownList()
        {
            ...
            MiscUtil.PopulateCMConsultantWorkAreaByCosultantID(ddlConsultantWorkAreaID, false,this.OverviewConsultantID);
        ...
        private CMConsultantAssignedWorkAreaEntity BuildCMConsultantAssignedWorkAreaEntity()
        {
            ...
            cMConsultantAssignedWorkAreaEntity.ConsultantID = this.OverviewConsultantID;
