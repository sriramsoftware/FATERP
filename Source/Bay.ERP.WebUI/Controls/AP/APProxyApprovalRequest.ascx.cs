...
{
    public partial class APProxyApprovalRequestControl : BaseControl
    {       
        #region Properties
        ...
        private void BindList()
        {
            ...
            lvAPMemberFeedback.DataSource = APRobot.GetApprovalRequests_DetailedByProxyMember(employeeID);                            
