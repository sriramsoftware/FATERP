...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Default.ascx.cs"
    Inherits="Bay.ERP.Web.UI.APDefaultControl" %>
                ...
                <ItemTemplate>
                    <tr class="r">
                        ...
                        <td class="i">
                            ...
                            <asp:Label ID="lblItemDetail" runat="server"></asp:Label>
                        </td>
                        <td class="i">
                            <%# Eval("DepartmentName")%>
                        </td>
                        ...
                        <td class="i">
                            <%# Eval("FeedbackRequestDate") != null ? ((DateTime)Eval("FeedbackRequestDate")).ToString(Bay.ERP.Web.UI.UIConstants.SHORT_DATE_FORMAT) : ""%>
                        </td>
                        <td class="i">
