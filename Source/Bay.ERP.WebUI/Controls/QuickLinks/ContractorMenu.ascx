<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContractorMenu.ascx.cs"
    Inherits="Bay.ERP.Web.UI.ContractorMenuControl" %>
        ...
        <td>
            <div class="ql-content">
                <div class="ql-content-inner">                
                    ...
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="contractorSiteMap" runat="server" ShowStartingNode="false" />
                </div>
            </div>
        </td>
