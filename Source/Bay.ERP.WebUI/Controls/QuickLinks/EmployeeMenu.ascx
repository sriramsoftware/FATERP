<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmployeeMenu.ascx.cs"
    Inherits="Bay.ERP.Web.UI.EmployeeMenuControl" %>
        ...
        <td>
            <div class="ql-content">
                <div class="ql-content-inner">                
                    ...
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="employeeSiteMap" runat="server" ShowStartingNode="false" />
                </div>
            </div>
        </td>
