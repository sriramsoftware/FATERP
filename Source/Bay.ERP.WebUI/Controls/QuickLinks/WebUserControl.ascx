<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControl.ascx.cs"
    Inherits="Bay.ERP.Web.UI.TempQuickLink" %>
        ...
        <td>
            <div class="ql-content">
                <div class="ql-content-inner">                
                    <asp:Menu ID="mnuQuickLink" runat="server" DataSourceID="SiteMapDataSource1" StaticDisplayLevels="2">
                        ...
                        <StaticItemTemplate>
                            ...
                            <div id="Div2" runat="server" visible='<%# (Eval("Depth").ToString() == "1") ? true : false %>' style="padding-left: 20px; padding-bottom: 3px;">
                                <div style="float: left; width: 16px; padding-top: 7px;">
                    ...
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="qlSiteMap" runat="server" ShowStartingNode="false" />
                </div>
            </div>
        </td>
