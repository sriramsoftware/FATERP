<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SupplierMenu.ascx.cs"
    Inherits="Bay.ERP.Web.UI.SupplierMenuControl" %>
        ...
        <td>
            <div class="ql-content">
                <div class="ql-content-inner">                
                    ...
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="supplierSiteMap" runat="server" ShowStartingNode="false" />
                </div>
            </div>
        </td>
