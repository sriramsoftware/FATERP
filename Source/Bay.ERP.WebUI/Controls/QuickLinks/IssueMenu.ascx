<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IssueMenu.ascx.cs"
    Inherits="Bay.ERP.Web.UI.IssueMenuControl" %>
        ...
        <td>
            <div class="ql-content">
                <div class="ql-content-inner">                
                    ...
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" SiteMapProvider="issueSiteMap" runat="server" ShowStartingNode="false" />
                </div>
            </div>
        </td>
