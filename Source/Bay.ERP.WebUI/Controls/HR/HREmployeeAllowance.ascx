...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HREmployeeAllowance.ascx.cs"
    Inherits="Bay.ERP.Web.UI.HREmployeeAllowanceControl" %>
        ...
        <div>
            ...
            <div>
                ...
                <asp:ObjectDataSource ID="odsHREmployeeAllowance" runat="server" SelectMethod="GetPagedData"
                    ...
                    StartRowIndexParameterName="startRowIndex" TypeName="Bay.ERP.Web.UI.HREmployeeAllowanceDataSource"
