...
{
    public partial class HREmployeeLeaveApplicationForFrontDeskControl : BaseControl
    {       
        #region Properties
        ...
        private Boolean ValidationInput()
        {
            ...
            if (flag)
            {
                ...
                String fe_alreadyRequested2 = SqlExpressionBuilder.PrepareFilterExpression(HREmployeeLeaveApplicationEntity.FLD_NAME_EmployeeID, Int64.Parse(ddlEmployeeID.SelectedValue).ToString(), SQLMatchType.Equal);
        ...
        private Decimal? GetToalLeaveEnjoyed()
        {
            ...
            String filterEmployeeID = "" + Int64.Parse(ddlEmployeeID.SelectedValue) + "";
        ...
        private Decimal? GetToalLeaveEarned()
        {
            ...
            String fe = "EmployeeID = " + Int64.Parse(ddlEmployeeID.SelectedValue) + " and FiscalYearID = " + fiscalYearID + "";
        ...
        {
            String fe = "EmployeeID = " + Int64.Parse(ddlEmployeeID.SelectedValue) + " and LeaveApplicationApplicationStatusID = " + MasterDataConstants.MDLeaveApplicatoinStatus.PENDING + "";
        ...
        private HREmployeeLeaveApplicationEntity BuildHREmployeeLeaveApplicationEntity()
        {
            ...
            if (ddlEmployeeID.Items.Count > 0)
            {
                ...
                {
                    hREmployeeLeaveApplicationEntity.EmployeeID = Int64.Parse(ddlEmployeeID.SelectedValue);
                }
            }
