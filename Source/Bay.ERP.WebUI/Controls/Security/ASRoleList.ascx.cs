...
{
    public partial class ASRoleListControl : BaseControl
    {       
        ...
        protected void rgASSiteMap_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            if (e.Item.ItemType == ListViewItemType.DataItem)
            {
               ...
               // ASRo ent = (REQRequisition_DetailedEntity)dataItem.DataItem;

                LinkButton lnkbtnEditAccess = (LinkButton)e.Item.FindControl("lnkbtnEditAccess");
                LinkButton lnkbtnDelete = (LinkButton)e.Item.FindControl("lnkbtnDelete");

                lnkbtnEditAccess.CommandArgument = "Admin"; //Need to change here.
                lnkbtnDelete.CommandArgument = "CM";  //Need to change here.
