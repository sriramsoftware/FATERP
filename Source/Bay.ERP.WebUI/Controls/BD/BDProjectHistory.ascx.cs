...
{
    public partial class BDProjectHistoryControl : ProjectBaseControl
    {       
        #region Properties
        ...
        private void PrepareInitialView()
        {
            ...
            txtHistoryDate.Text = String.Empty;
        ...
        private BDProjectHistoryEntity BuildBDProjectHistoryEntity()
        {
            ...
            bDProjectHistoryEntity.ProjectID = this.OverviewProjectID;
        ...
        {
            String fe = SqlExpressionBuilder.PrepareFilterExpression("BDProjectHistory." + BDProjectHistoryEntity.FLD_NAME_ProjectID, this.OverviewProjectID.ToString(), SQLMatchType.Equal);
