...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BDProjectHistory.ascx.cs"
    Inherits="Bay.ERP.Web.UI.BDProjectHistoryControl" %>
                ...
                <div class="TableRow" style="text-align: center;">
                    ...
                    <div class="TableFormContent">
                        <kti:SecureButton ID="btnSubmit" ValidationGroup="BDProjectHistoryEntity" OnClick="btnSave_Click"
                            runat="server" Text="Add" UniqueKey="BDProjectHistoryControl_Submit_key" />
                        <kti:SecureButton ID="btnAddNew" Visible="false" OnClick="btnAddNew_Click" runat="server"
                            Text="Add New" UniqueKey="BDProjectHistoryControl_AddNew_key" />
                            ...
                            <tr class="r">
                                ...
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnEdit" runat="server" CssClass="CommonButtonLink"
                                        ...
                                        UniqueKey="BDProjectHistory_lvBDProjectHistory_Edit_key" />
                                </td>
                                <td class="i">
                                    <kti:SecureLinkButton ID="lnkBtnDelete" runat="server" CssClass="CommonButtonLink"
                                        Text="Delete" CommandName="DeleteItem" OnClientClick="return confirm('Are you sure to delete Project History?')"
                                        CommandArgument='<%#Eval("ProjectHistoryID")%>' UniqueKey="BDProjectHistory_lvBDProjectHistory_Delete_key" />
                                </td>
                                <td class="rp">
                                    &nbsp;
                                </td>
