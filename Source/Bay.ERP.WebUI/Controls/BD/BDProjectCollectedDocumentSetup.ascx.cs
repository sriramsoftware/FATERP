...
{
    public partial class BDProjectCollectedDocumentSetupControl : ProjectBaseControl
    {
        #region Extra
        ...
        IList<BDProjectDocumentTemplateMapEntity> templateDocumentList = new List<BDProjectDocumentTemplateMapEntity>();
        ...
        {
            MiscUtil.PopulateBDProjectDocumentTemplate(ddlProjectDocumentTemplateID, true);
        }
        ...
        {
            String fe = SqlExpressionBuilder.PrepareFilterExpression(BDProjectCollectedDocumentInfoEntity.FLD_NAME_ProjectID, this.OverviewProjectID.ToString(), SQLMatchType.Equal);
            ...
            currentProjectNodes = treeDocument.CheckedNodes;
        }
        ...
        {
            templateDocumentList = new List<BDProjectDocumentTemplateMapEntity>();

            Int64 projectDocumentTemplateID = 0;

            Int64.TryParse(ddlProjectDocumentTemplateID.SelectedValue, out projectDocumentTemplateID);
            ...
            if (projectDocumentTemplateID > 0)
            {
                ...
                templateDocumentList = FCCBDProjectDocumentTemplateMap.GetFacadeCreate().GetIL(null, null, String.Empty, fe, DatabaseOperationType.LoadWithFilterExpression);
            }
