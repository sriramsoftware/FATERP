...
<%@ Page Language="C#" MasterPageFile="~/Template/Default.master" AutoEventWireup="true" CodeFile="CRMCommunicationReportPage.aspx.cs" Inherits="Bay.ERP.Web.UI.CRMCommunicationReportPage" Title="Bay's ERP New" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphPageTitle" runat="Server">
    <h1>Sales Communication Summary</h1>
</asp:Content>
        ...
        <div> 
            <table style="width:500px; border-collapse: collapse;">
                <tr>
                    <td class="style2">
                        Database:<br />
                        <asp:DropDownList ID="DropDownProcess" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource1" DataTextField="Name" 
                            DataValueField="ProcessCategoryID" Width="140px">
                        </asp:DropDownList>
                    </td>
                    <td>
                        Please Select Contact Person<br />
                        <asp:DropDownList ID="DropDownLeadName" runat="server" AutoPostBack="True" 
                            DataSourceID="SqlDataSource3" DataTextField="ContactFullName" 
                            DataValueField="BuyerBasicInfoID" Width="260px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr style="vertical-align: top">
                    <td class="style2">
                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                            ...
                            CellPadding="4" DataSourceID="SqlDataPersonDetails" ForeColor="Black" 
                            GridLines="Horizontal" HeaderText="Buyer Personal Details" Height="50px" 
                            Width="366px">
                            <EditRowStyle BackColor="#CC3333" Font-Bold="True" ForeColor="White" />
                            <Fields>
                                <asp:BoundField DataField="BuyerBasicInfoID" HeaderText="BuyerBasicInfoID" 
                                    InsertVisible="False" ReadOnly="True" SortExpression="BuyerBasicInfoID" />
                                <asp:BoundField DataField="ContactFullName" HeaderText="ContactFullName" 
                                    SortExpression="ContactFullName" />
                                <asp:BoundField DataField="MobileNo" HeaderText="MobileNo" 
                                    SortExpression="MobileNo" />
                                <asp:BoundField DataField="LandPhone" HeaderText="LandPhone" 
                                    SortExpression="LandPhone" />
                                ...
                                <asp:BoundField DataField="AreaNeededFrom" HeaderText="AreaNeededFrom" 
                                    SortExpression="AreaNeededFrom" />
                                <asp:BoundField DataField="AreaNeededTo" HeaderText="AreaNeededTo" 
                                    SortExpression="AreaNeededTo" />
                                <asp:BoundField DataField="ParkingNeeded" HeaderText="ParkingNeeded" 
                                    SortExpression="ParkingNeeded" />
                                <asp:BoundField DataField="ToiletNeeded" HeaderText="ToiletNeeded" 
                                    SortExpression="ToiletNeeded" />
                                <asp:BoundField DataField="UnitNeeded" HeaderText="UnitNeeded" 
                                    SortExpression="UnitNeeded" />
                                <asp:BoundField DataField="LeadGeneratedByEmployeeID" 
                                    HeaderText="LeadGeneratedByEmployeeID" 
                                    SortExpression="LeadGeneratedByEmployeeID" />
                                <asp:BoundField DataField="LeadManagedByOneEmployeeID" 
                                    HeaderText="LeadManagedByOneEmployeeID" 
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="Email" DataTextField="Email" 
                                    HeaderText="Email" NavigateUrl="mailto:@email" Text="Email" />
                            </Fields>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                GridLines="Horizontal" PageSize="20" Width="90%" BackColor="White" 
                BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                <Columns>
                    <asp:BoundField DataField="CommunicationID" HeaderText="ID" 
                        ReadOnly="True" SortExpression="CommunicationID" />
                    <asp:BoundField DataField="CreateDate" HeaderText="Create Date" ReadOnly="True" 
                        SortExpression="CreateDate" DataFormatString="{0:d}" />
                    <asp:BoundField DataField="Topics" HeaderText="Topics" ReadOnly="True" 
                        SortExpression="Topics" />
                    <asp:BoundField DataField="Note" HeaderText="Details Note" ReadOnly="True" 
                        SortExpression="Note" >
                    <HeaderStyle Wrap="False" />
                    <ItemStyle Width="80px" />
                    </asp:BoundField>
                    <asp:CheckBoxField DataField="IsIWillCall" HeaderText="Will Call" 
                        ReadOnly="True" SortExpression="IsIWillCall" />
                    <asp:BoundField DataField="NextCommunicationDate" HeaderText="Next Comm. Date" 
                        ReadOnly="True" SortExpression="NextCommunicationDate" 
                        DataFormatString="{0:d}" />
                    <asp:BoundField DataField="NextAction" HeaderText="Next Action" 
                        SortExpression="NextAction" ReadOnly="True" />
                    <asp:BoundField DataField="ContactFullName" 
                        HeaderText="Contact FullName" ReadOnly="True" 
                        SortExpression="ContactFullName" />
                    ...
                    <asp:BoundField DataField="CommunicationStatusName" 
                        HeaderText="Status" ReadOnly="True" 
                        SortExpression="CommunicationStatusName" />
                    <asp:BoundField DataField="CreatedByMemberFullName" 
                        HeaderText="CreatedBy " ReadOnly="True" 
...
and ProcessCategoryID IN (8)">
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                ...
                SelectCommand="SELECT BuyerBasicInfoID, ContactFullName, Type FROM vw_CRMLeads WHERE (Type = @Type)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownProcess" DbType="String" 
                        DefaultValue="" Name="Type" PropertyName="SelectedItem.text" />
                </SelectParameters>
            </asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownProcess" Name="pid" 
                        PropertyName="SelectedValue" Type="Int16" />
                    <asp:ControlParameter ControlID="DropDownLeadName" Name="leadId" 
                        PropertyName="SelectedValue" DbType="Single" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataPersonDetails" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ETCON %>" 
                oninserting="SqlDataSource1_Inserting" 
                ProviderName="<%$ ConnectionStrings:ETCON.ProviderName %>" 
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="DropDownLeadName" Name="bid" 
                        PropertyName="SelectedValue" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:ControlParameter ControlID="DetailsView1" Name="BuyerTypeID" 
                    ...
                    <asp:Parameter Name="InterestedLandLocationID" Type="Int64" />
                    <asp:Parameter Name="CityID" Type="Int64" />
                    <asp:ControlParameter ControlID="DetailsView1" Name="AreaNeededFrom" 
