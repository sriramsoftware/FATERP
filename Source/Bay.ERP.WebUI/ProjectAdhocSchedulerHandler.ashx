<%@ WebHandler Language="C#" Class="ProjectAdhocSchedulerHandler" %>
...
public class ProjectAdhocSchedulerHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
       ...
       IList<Bay.ERP.Common.BusinessEntity.ScheduleJSON> scheduleJSONList = new List<Bay.ERP.Common.BusinessEntity.ScheduleJSON>();
        String fe = Bay.ERP.Common.Helper.SqlExpressionBuilder.PrepareFilterExpression(Bay.ERP.Common.BusinessEntities.OTIssueEntity.FLD_NAME_IssueIdentityCategoryID, Bay.ERP.Web.UI.MasterDataConstants.IssueIdentityCategory.PROJECT_ADHOC_ISSUE.ToString(), Bay.ERP.Common.Shared.SQLMatchType.Equal);
        if(projectID != null)
        {
            String fe1 = Bay.ERP.Common.Helper.SqlExpressionBuilder.PrepareFilterExpression(Bay.ERP.Common.BusinessEntities.OTIssueEntity.FLD_NAME_ReferenceID, projectID.ToString(), Bay.ERP.Common.Shared.SQLMatchType.Equal);
            fe = Bay.ERP.Common.Helper.SqlExpressionBuilder.PrepareFilterExpression(fe, Bay.ERP.Common.Shared.SQLJoinType.AND, fe1);
        }
