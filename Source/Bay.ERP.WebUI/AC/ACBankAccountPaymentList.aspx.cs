...
{
    public partial class ACBankAccountPaymentListPage : BasePage
    {
        #region Veriables
        ...
        public override string UniqueKey
        {
            get
            {
                return "ACBankAccountPaymentListEntity_Page";
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ucACBankAccountPaymentListEntity.PageAPType = MasterDataConstants.ACPaymentType.BANK_ACCOUNT_PAYMENT;
