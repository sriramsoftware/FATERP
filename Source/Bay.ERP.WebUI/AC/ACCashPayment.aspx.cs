...
{
    public partial class ACCashPaymentPage : BasePage
    {
        #region Veriables
        ...
        public override string UniqueKey
        {
            get
            {
                return "ACCashPaymentEntity_Page";
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ucACBankAccountPaymentEntity.PageAPType = MasterDataConstants.ACPaymentType.CASH_PAYMENT;
