...
{
    [Serializable]
    [DataContract(Name = "CMNMDEventIdentityCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMNMDEventIdentityCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EventIdentityCategoryID <= 0);
            }
        }
        ...
        public CMNMDEventIdentityCategoryEntity() : base()
        {
        }
