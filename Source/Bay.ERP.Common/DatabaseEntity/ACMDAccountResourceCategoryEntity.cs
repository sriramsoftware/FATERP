...
{
    [Serializable]
    [DataContract(Name = "ACMDAccountResourceCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACMDAccountResourceCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (AccountResourceCategoryID <= 0);
            }
        }
        ...
        public ACMDAccountResourceCategoryEntity() : base()
        {
        }
