...
{
    [Serializable]
    [DataContract(Name = "ACCPostPayableStatementDetail", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACCPostPayableStatementDetailEntity : BaseEntity
    {
        #region Properties
        ...
        public ACCPostPayableStatementDetailEntity() : base()
        {
        }
