...
{
    [Serializable]
    [DataContract(Name = "CMNMDSharedSetting", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMNMDSharedSettingEntity : BaseEntity
    {
        #region Properties
        ...
        public CMNMDSharedSettingEntity() : base()
        {
        }
