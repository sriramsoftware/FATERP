...
{
    [Serializable]
    [DataContract(Name = "MDFloorUnitLocationCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDFloorUnitLocationCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (FloorUnitLocationCategoryID <= 0);
            }
        }
        ...
        public MDFloorUnitLocationCategoryEntity() : base()
        {
        }
