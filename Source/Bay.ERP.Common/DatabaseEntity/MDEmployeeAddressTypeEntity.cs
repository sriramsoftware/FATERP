...
{
    [Serializable]
    [DataContract(Name = "MDEmployeeAddressType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEmployeeAddressTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EmployeeAddressTypeID <= 0);
            }
        }
        ...
        public MDEmployeeAddressTypeEntity() : base()
        {
        }
