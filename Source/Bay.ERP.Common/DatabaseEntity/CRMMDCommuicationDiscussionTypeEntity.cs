...
{
    [Serializable]
    [DataContract(Name = "CRMMDCommuicationDiscussionType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMMDCommuicationDiscussionTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (CommuicationDiscussionTypeID <= 0);
            }
        }
        ...
        public CRMMDCommuicationDiscussionTypeEntity() : base()
        {
        }
