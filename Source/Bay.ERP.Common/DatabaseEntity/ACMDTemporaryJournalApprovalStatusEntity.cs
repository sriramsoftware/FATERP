...
{
    [Serializable]
    [DataContract(Name = "ACMDTemporaryJournalApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACMDTemporaryJournalApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (TemporyJournalApprovalStatusID <= 0);
            }
        }
        ...
        public ACMDTemporaryJournalApprovalStatusEntity() : base()
        {
        }
