...
{
    [Serializable]
    [DataContract(Name = "ACMDBankAccountDepositApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACMDBankAccountDepositApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (BankAccountDepositApprovalStatusID <= 0);
            }
        }
        ...
        public ACMDBankAccountDepositApprovalStatusEntity() : base()
        {
        }
