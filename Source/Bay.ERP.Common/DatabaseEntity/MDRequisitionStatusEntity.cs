...
{
    [Serializable]
    [DataContract(Name = "MDRequisitionStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDRequisitionStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public MDRequisitionStatusEntity() : base()
        {
        }
