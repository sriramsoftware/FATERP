...
{
    [Serializable]
    [DataContract(Name = "MDSalarySessionStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDSalarySessionStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (SalarySessionStatusID <= 0);
            }
        }
        ...
        public MDSalarySessionStatusEntity() : base()
        {
        }
