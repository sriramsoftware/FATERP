...
{
    [Serializable]
    [DataContract(Name = "MDAssetCondition", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDAssetConditionEntity : BaseEntity
    {
        #region Properties
        ...
        public MDAssetConditionEntity() : base()
        {
        }
