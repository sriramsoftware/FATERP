...
{
    [Serializable]
    [DataContract(Name = "ACClassType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACClassTypeEntity : BaseEntity
    {
        #region Properties
