...
{
    [Serializable]
    [DataContract(Name = "MDSupplierAddressType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDSupplierAddressTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (SupplierAddressTypeID <= 0);
            }
        }
        ...
        public MDSupplierAddressTypeEntity() : base()
        {
        }
