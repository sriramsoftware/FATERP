...
{
    [Serializable]
    [DataContract(Name = "ACMDBankAccountType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACMDBankAccountTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public ACMDBankAccountTypeEntity() : base()
        {
        }
