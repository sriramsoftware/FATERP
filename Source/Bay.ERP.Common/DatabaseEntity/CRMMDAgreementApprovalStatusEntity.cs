...
{
    [Serializable]
    [DataContract(Name = "CRMMDAgreementApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMMDAgreementApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (AgreementApprovalStatusID <= 0);
            }
        }
        ...
        public CRMMDAgreementApprovalStatusEntity() : base()
        {
        }
