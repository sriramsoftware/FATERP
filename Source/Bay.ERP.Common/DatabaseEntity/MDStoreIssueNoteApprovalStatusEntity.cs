...
{
    [Serializable]
    [DataContract(Name = "MDStoreIssueNoteApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDStoreIssueNoteApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (StoreIssueNoteApprovalStatusID <= 0);
            }
        }
        ...
        public MDStoreIssueNoteApprovalStatusEntity() : base()
        {
        }
