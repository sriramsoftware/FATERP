...
{
    [Serializable]
    [DataContract(Name = "CMNMDEventOption", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMNMDEventOptionEntity : BaseEntity
    {
        #region Properties
        ...
        public CMNMDEventOptionEntity() : base()
        {
        }
