...
{
    [Serializable]
    [DataContract(Name = "MDFloorCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDFloorCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public MDFloorCategoryEntity() : base()
        {
        }
