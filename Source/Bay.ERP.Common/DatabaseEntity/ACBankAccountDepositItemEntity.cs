...
{
    [Serializable]
    [DataContract(Name = "ACBankAccountDepositItem", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACBankAccountDepositItemEntity : BaseEntity
    {
        #region Properties
        ...
        public ACBankAccountDepositItemEntity() : base()
        {
        }
