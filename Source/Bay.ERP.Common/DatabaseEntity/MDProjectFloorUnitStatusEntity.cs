...
{
    [Serializable]
    [DataContract(Name = "MDProjectFloorUnitStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDProjectFloorUnitStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public MDProjectFloorUnitStatusEntity() : base()
        {
        }
