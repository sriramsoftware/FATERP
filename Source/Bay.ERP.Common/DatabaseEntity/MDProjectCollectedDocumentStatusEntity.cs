...
{
    [Serializable]
    [DataContract(Name = "MDProjectCollectedDocumentStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDProjectCollectedDocumentStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ProjectCollectedDocumentStatusID <= 0);
            }
        }
        ...
        public MDProjectCollectedDocumentStatusEntity() : base()
        {
        }
