...
{
    [Serializable]
    [DataContract(Name = "MDSalaryRateDuration", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDSalaryRateDurationEntity : BaseEntity
    {
        #region Properties
        ...
        public MDSalaryRateDurationEntity() : base()
        {
        }
