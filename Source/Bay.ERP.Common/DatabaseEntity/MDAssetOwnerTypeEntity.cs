...
{
    [Serializable]
    [DataContract(Name = "MDAssetOwnerType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDAssetOwnerTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public MDAssetOwnerTypeEntity() : base()
        {
        }
