...
{
    [Serializable]
    [DataContract(Name = "BDMDProcessAssignedResourceApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDMDProcessAssignedResourceApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ProcessAssignedResourceApprovalStatusID <= 0);
            }
        }
        ...
        public BDMDProcessAssignedResourceApprovalStatusEntity() : base()
        {
        }
