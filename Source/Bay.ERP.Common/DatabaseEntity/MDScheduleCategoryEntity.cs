...
{
    [Serializable]
    [DataContract(Name = "MDScheduleCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDScheduleCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public MDScheduleCategoryEntity() : base()
        {
        }
