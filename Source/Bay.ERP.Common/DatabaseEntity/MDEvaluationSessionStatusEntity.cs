...
{
    [Serializable]
    [DataContract(Name = "MDEvaluationSessionStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEvaluationSessionStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EvaluationSessionStatusID <= 0);
            }
        }
        ...
        public MDEvaluationSessionStatusEntity() : base()
        {
        }
