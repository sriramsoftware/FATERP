...
{
    [Serializable]
    [DataContract(Name = "MDIssueIdentityCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDIssueIdentityCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (IssueIdentityCategoryID <= 0);
            }
        }
        ...
        public MDIssueIdentityCategoryEntity() : base()
        {
        }
