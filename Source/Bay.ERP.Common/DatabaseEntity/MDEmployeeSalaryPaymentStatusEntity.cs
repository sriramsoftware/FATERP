...
{
    [Serializable]
    [DataContract(Name = "MDEmployeeSalaryPaymentStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEmployeeSalaryPaymentStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EmployeeSalaryPaymentStatusID <= 0);
            }
        }
        ...
        public MDEmployeeSalaryPaymentStatusEntity() : base()
        {
        }
