...
{
    [Serializable]
    [DataContract(Name = "PRMPreBOQDetailHistory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMPreBOQDetailHistoryEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMPreBOQDetailHistoryEntity() : base()
        {
        }
