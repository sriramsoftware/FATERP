...
{
    [Serializable]
    [DataContract(Name = "MDScheduleIdentityCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDScheduleIdentityCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ScheduleIdentityCategoryID <= 0);
            }
        }
        ...
        public MDScheduleIdentityCategoryEntity() : base()
        {
        }
