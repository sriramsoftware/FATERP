...
{
    [Serializable]
    [DataContract(Name = "MDSupplierType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDSupplierTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public MDSupplierTypeEntity() : base()
        {
        }
