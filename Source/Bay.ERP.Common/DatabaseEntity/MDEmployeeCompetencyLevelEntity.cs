...
{
    [Serializable]
    [DataContract(Name = "MDEmployeeCompetencyLevel", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEmployeeCompetencyLevelEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EmployeeCompetencyLevelID <= 0);
            }
        }
        ...
        public MDEmployeeCompetencyLevelEntity() : base()
        {
        }
