...
{
    [Serializable]
    [DataContract(Name = "MDBankAccountCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDBankAccountCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (BankAccountCategoryID <= 0);
            }
        }
        ...
        public MDBankAccountCategoryEntity() : base()
        {
        }
