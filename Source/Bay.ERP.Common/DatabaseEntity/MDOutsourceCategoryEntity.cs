...
{
    [Serializable]
    [DataContract(Name = "MDOutsourceCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDOutsourceCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public MDOutsourceCategoryEntity() : base()
        {
        }
