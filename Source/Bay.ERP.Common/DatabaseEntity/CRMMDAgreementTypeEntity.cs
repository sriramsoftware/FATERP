...
{
    [Serializable]
    [DataContract(Name = "CRMMDAgreementType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMMDAgreementTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMMDAgreementTypeEntity() : base()
        {
        }
