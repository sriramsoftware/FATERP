...
{
    [Serializable]
    [DataContract(Name = "BDProcessAssignedResourceMap", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDProcessAssignedResourceMapEntity : BaseEntity
    {
        #region Properties
        ...
        public BDProcessAssignedResourceMapEntity() : base()
        {
        }
