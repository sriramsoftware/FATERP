...
{
    [Serializable]
    [DataContract(Name = "MDReferenceLibraryCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDReferenceLibraryCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ReferenceLibraryCategoryID <= 0);
            }
        }
        ...
        public MDReferenceLibraryCategoryEntity() : base()
        {
        }
