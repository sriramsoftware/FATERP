...
{
    [Serializable]
    [DataContract(Name = "BDTaskTemplate", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDTaskTemplateEntity : BaseEntity
    {
        #region Properties
        ...
        public BDTaskTemplateEntity() : base()
        {
        }
