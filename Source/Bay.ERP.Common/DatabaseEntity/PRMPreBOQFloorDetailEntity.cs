...
{
    [Serializable]
    [DataContract(Name = "PRMPreBOQFloorDetail", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMPreBOQFloorDetailEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMPreBOQFloorDetailEntity() : base()
        {
        }
