...
{
    [Serializable]
    [DataContract(Name = "ACDepreciationMethod", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACDepreciationMethodEntity : BaseEntity
    {
        #region Properties
        ...
        public ACDepreciationMethodEntity() : base()
        {
        }
