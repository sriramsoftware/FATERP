...
{
    [Serializable]
    [DataContract(Name = "MDEmployeeAdditionalInformationCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEmployeeAdditionalInformationCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EmployeeAdditionalInformationCategoryID <= 0);
            }
        }
        ...
        public MDEmployeeAdditionalInformationCategoryEntity() : base()
        {
        }
