...
{
    [Serializable]
    [DataContract(Name = "CMNProcessCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMNProcessCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public CMNProcessCategoryEntity() : base()
        {
        }
