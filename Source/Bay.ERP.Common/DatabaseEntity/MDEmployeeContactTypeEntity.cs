...
{
    [Serializable]
    [DataContract(Name = "MDEmployeeContactType", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEmployeeContactTypeEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EmployeeContactTypeID <= 0);
            }
        }
        ...
        public MDEmployeeContactTypeEntity() : base()
        {
        }
