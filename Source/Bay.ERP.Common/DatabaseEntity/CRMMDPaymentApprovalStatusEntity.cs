...
{
    [Serializable]
    [DataContract(Name = "CRMMDPaymentApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMMDPaymentApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (PaymentApprovalStatusID <= 0);
            }
        }
        ...
        public CRMMDPaymentApprovalStatusEntity() : base()
        {
        }
