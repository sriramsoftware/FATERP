...
{
    [Serializable]
    [DataContract(Name = "MDEventLocationCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDEventLocationCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (EventLocationCategoryID <= 0);
            }
        }
        ...
        public MDEventLocationCategoryEntity() : base()
        {
        }
