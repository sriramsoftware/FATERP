...
{
    [Serializable]
    [DataContract(Name = "MDLeaveApplicationApplicationStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDLeaveApplicationApplicationStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (LeaveApplicationApplicationStatusID <= 0);
            }
        }
        ...
        public MDLeaveApplicationApplicationStatusEntity() : base()
        {
        }
