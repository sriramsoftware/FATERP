...
{
    [Serializable]
    [DataContract(Name = "MDSurveyBuildingStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDSurveyBuildingStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (SurveyBuildingStatusID <= 0);
            }
        }
        ...
        public MDSurveyBuildingStatusEntity() : base()
        {
        }
