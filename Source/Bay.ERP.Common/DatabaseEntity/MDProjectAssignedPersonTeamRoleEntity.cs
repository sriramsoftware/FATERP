...
{
    [Serializable]
    [DataContract(Name = "MDProjectAssignedPersonTeamRole", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDProjectAssignedPersonTeamRoleEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ProjectAssignedPersonTeamRoleID <= 0);
            }
        }
        ...
        public MDProjectAssignedPersonTeamRoleEntity() : base()
        {
        }
