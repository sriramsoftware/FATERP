...
{
    [Serializable]
    [DataContract(Name = "MDBillApprovalStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDBillApprovalStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public MDBillApprovalStatusEntity() : base()
        {
        }
