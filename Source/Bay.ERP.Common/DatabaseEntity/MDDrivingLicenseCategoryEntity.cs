...
{
    [Serializable]
    [DataContract(Name = "MDDrivingLicenseCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDDrivingLicenseCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (DrivingLicenseCategoryID <= 0);
            }
        }
        ...
        public MDDrivingLicenseCategoryEntity() : base()
        {
        }
