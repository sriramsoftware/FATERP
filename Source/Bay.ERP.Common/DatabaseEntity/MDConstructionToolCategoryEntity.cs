...
{
    [Serializable]
    [DataContract(Name = "MDConstructionToolCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDConstructionToolCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (ConstructionToolCategoryID <= 0);
            }
        }
        ...
        public MDConstructionToolCategoryEntity() : base()
        {
        }
