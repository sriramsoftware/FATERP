...
{
    [Serializable]
    [DataContract(Name = "BDProjectFloor", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDProjectFloorEntity : BaseEntity
    {
        #region Properties
        ...
        public BDProjectFloorEntity() : base()
        {
        }
