...
{
    [Serializable]
    [DataContract(Name = "MDInventoryTransferStatus", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDInventoryTransferStatusEntity : BaseEntity
    {
        #region Properties
        ...
        public override bool IsNew
        {
            ...
            get
            {
                return (InventoryTransferStatusID <= 0);
            }
        }
        ...
        public MDInventoryTransferStatusEntity() : base()
        {
        }
