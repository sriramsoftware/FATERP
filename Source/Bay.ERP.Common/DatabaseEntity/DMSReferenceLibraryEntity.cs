...
{
    [Serializable]
    [DataContract(Name = "DMSReferenceLibrary", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class DMSReferenceLibraryEntity : BaseEntity
    {
        #region Properties
        ...
        public DMSReferenceLibraryEntity() : base()
        {
        }
