...
{
    [Serializable]
    [DataContract(Name = "HREmployeeEvaluationReport", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class HREmployeeEvaluationReportEntity : BaseEntity
    {
        #region Properties
        ...
        public HREmployeeEvaluationReportEntity() : base()
        {
        }
