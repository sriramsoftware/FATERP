...
{
    [Serializable]
    [DataContract(Name = "CMConsultantWorkArea", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMConsultantWorkAreaEntity : BaseEntity
    {
        #region Properties
        ...
        public CMConsultantWorkAreaEntity() : base()
        {
        }
