...
{
    [Serializable]
    [DataContract(Name = "MDIssueCategory", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class MDIssueCategoryEntity : BaseEntity
    {
        #region Properties
        ...
        public MDIssueCategoryEntity() : base()
        {
        }
