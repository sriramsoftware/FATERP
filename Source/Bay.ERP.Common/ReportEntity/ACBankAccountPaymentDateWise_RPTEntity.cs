...
{
    [Serializable]
    [DataContract(Name = "ACBankAccountPaymentDateWise_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACBankAccountPaymentDateWise_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACBankAccountPaymentDateWise_RPTEntity() : base()
        {
        }
