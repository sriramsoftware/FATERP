...
{
    [Serializable]
    [DataContract(Name = "ACBalanceSheet_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACBalanceSheet_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACBalanceSheet_RPTEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_OpeningBalance = "OpeningBalance";
