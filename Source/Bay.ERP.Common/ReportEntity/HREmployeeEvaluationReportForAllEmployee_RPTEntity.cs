...
{
    [Serializable]
    [DataContract(Name = "HREmployeeEvaluationReportForAllEmployee_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class HREmployeeEvaluationReportForAllEmployee_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        [DataMember]
        public Int32? MarksOutOf
        {
            get { return _MarksOutOf; }
            set { _MarksOutOf = value; }
        }
        ...
        public HREmployeeEvaluationReportForAllEmployee_RPTEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_MarksOutOf = "MarksOutOf";
