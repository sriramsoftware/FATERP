...
{
    [Serializable]
    [DataContract(Name = "OTIssueWithEmployeeandDateWise_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class OTIssueWithEmployeeandDateWise_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        private String _SupervisorDesignationName;
        ...
        [DataMember]
        public String SupervisorDesignationName
        {
            get { return _SupervisorDesignationName; }
            set { _SupervisorDesignationName = value; }
        }
        ...
        public OTIssueWithEmployeeandDateWise_RPTEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_SupervisorDesignationName = "SupervisorDesignationName";
