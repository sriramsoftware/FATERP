...
{
    [Serializable]
    [DataContract(Name = "ACTemporaryJournal_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACTemporaryJournal_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACTemporaryJournal_RPTEntity() : base()
        {
        }
