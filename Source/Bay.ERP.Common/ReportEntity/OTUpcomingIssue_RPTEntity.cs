...
{
    [Serializable]
    [DataContract(Name = "OTUpcomingIssue_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class OTUpcomingIssue_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public OTUpcomingIssue_RPTEntity() : base()
        {
        }
