...
{
    [Serializable]
    [DataContract(Name = "REQRequisition_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class REQRequisition_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public REQRequisition_RPTEntity() : base()
        {
        }
