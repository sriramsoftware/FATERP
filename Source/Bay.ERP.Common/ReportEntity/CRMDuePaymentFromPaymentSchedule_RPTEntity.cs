...
{
    [Serializable]
    [DataContract(Name = "CRMDuePaymentFromPaymentSchedule_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMDuePaymentFromPaymentSchedule_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMDuePaymentFromPaymentSchedule_RPTEntity() : base()
        {
        }
