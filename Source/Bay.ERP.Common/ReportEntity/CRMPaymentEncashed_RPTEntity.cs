...
{
    [Serializable]
    [DataContract(Name = "CRMPaymentEncashed_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMPaymentEncashed_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMPaymentEncashed_RPTEntity() : base()
        {
        }
