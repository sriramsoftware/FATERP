...
{
    [Serializable]
    [DataContract(Name = "ACAccount_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACAccount_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        private String _ParentAccountGroup;
        ...
        [DataMember]
        public String ParentAccountGroup
        {
            get { return _ParentAccountGroup; }
            set { _ParentAccountGroup = value; }
        }
        ...
        public ACAccount_RPTEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_ParentAccountGroup = "ParentAccountGroup";
