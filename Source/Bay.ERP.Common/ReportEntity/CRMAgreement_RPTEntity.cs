...
{
    [Serializable]
    [DataContract(Name = "CRMAgreement_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMAgreement_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMAgreement_RPTEntity() : base()
        {
        }
