...
{
    [Serializable]
    [DataContract(Name = "PRMMaterialReceive_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMMaterialReceive_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMMaterialReceive_RPTEntity() : base()
        {
        }
