...
{
    [Serializable]
    [DataContract(Name = "ACTrialBalanceForActiveFiscalYear_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACTrialBalanceForActiveFiscalYear_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACTrialBalanceForActiveFiscalYear_RPTEntity() : base()
        {
        }
