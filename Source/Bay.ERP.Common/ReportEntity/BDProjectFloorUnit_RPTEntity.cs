...
{
    [Serializable]
    [DataContract(Name = "BDProjectFloorUnit_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDProjectFloorUnit_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public BDProjectFloorUnit_RPTEntity()
            : base()
        {
        }
