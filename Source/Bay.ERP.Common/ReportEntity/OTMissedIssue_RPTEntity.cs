...
{
    [Serializable]
    [DataContract(Name = "OTMissedIssue_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class OTMissedIssue_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public OTMissedIssue_RPTEntity() : base()
        {
        }
