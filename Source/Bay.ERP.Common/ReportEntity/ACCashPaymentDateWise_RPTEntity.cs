...
{
    [Serializable]
    [DataContract(Name = "ACCashPaymentDateWise_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACCashPaymentDateWise_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACCashPaymentDateWise_RPTEntity() : base()
        {
        }
