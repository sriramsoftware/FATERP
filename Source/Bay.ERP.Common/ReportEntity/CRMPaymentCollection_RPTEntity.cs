...
{
    [Serializable]
    [DataContract(Name = "CRMPaymentCollection_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMPaymentCollection_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMPaymentCollection_RPTEntity() : base()
        {
        }
