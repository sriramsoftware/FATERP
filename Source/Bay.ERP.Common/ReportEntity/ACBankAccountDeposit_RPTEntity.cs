...
{
    [Serializable]
    [DataContract(Name = "ACBankAccountDeposit_RPT", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACBankAccountDeposit_RPTEntity : BaseEntity
    {
        #region Properties
        ...
        public ACBankAccountDeposit_RPTEntity() : base()
        {
        }
