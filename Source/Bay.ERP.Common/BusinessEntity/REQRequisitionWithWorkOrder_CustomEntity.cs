...
{
    [Serializable]
    [DataContract(Name = "REQRequisitionWithWorkOrder_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class REQRequisitionWithWorkOrder_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public REQRequisitionWithWorkOrder_CustomEntity() : base()
        {
        }
