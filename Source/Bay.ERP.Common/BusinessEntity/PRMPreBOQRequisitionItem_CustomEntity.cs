...
{
    [Serializable]
    [DataContract(Name = "PRMPreBOQRequisitionItem_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMPreBOQRequisitionItem_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMPreBOQRequisitionItem_CustomEntity() : base()
        {
        }
