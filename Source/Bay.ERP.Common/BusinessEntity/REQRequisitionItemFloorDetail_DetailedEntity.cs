...
{
    [Serializable]
    [DataContract(Name = "REQRequisitionItemFloorDetail_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class REQRequisitionItemFloorDetail_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        public REQRequisitionItemFloorDetail_DetailedEntity() : base()
        {
        }
