...
{
    [Serializable]
    [DataContract(Name = "CMConsultantEnlistedWorkArea_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMConsultantEnlistedWorkArea_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public CMConsultantEnlistedWorkArea_CustomEntity() : base()
        {
        }
