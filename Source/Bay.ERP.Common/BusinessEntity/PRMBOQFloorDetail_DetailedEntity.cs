...
{
    [Serializable]
    [DataContract(Name = "PRMBOQFloorDetail_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMBOQFloorDetail_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        private Int64? _PRMBOQDetailBOQID;
        ...
        [DataMember]
        public Int64? PRMBOQDetailBOQID
        {
            get { return _PRMBOQDetailBOQID; }
            set { _PRMBOQDetailBOQID = value; }
        }
        ...
        public PRMBOQFloorDetail_DetailedEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_PRMBOQDetailBOQID = "PRMBOQDetailBOQID";
