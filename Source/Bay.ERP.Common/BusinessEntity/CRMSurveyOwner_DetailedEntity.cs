...
{
    [Serializable]
    [DataContract(Name = "CRMSurveyOwner_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CRMSurveyOwner_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        public CRMSurveyOwner_DetailedEntity()
            : base()
        {
        }
