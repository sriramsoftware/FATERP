...
{
    [Serializable]
    [DataContract(Name = "PRMPreBOQDetail_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMPreBOQDetail_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMPreBOQDetail_CustomEntity() : base()
        {
        }
