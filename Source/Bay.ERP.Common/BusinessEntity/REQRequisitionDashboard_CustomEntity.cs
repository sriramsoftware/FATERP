...
{
    [Serializable]
    [DataContract(Name = "REQRequisitionDashboard_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class REQRequisitionDashboard_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public REQRequisitionDashboard_CustomEntity() : base()
        {
        }
