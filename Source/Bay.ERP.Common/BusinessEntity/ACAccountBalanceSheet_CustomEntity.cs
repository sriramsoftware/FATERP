...
{
    [Serializable]
    [DataContract(Name = "ACAccountBalanceSheet_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACAccountBalanceSheet_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public ACAccountBalanceSheet_CustomEntity() : base()
        {
        }
