...
{
    [Serializable]
    [DataContract(Name = "BDProject_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class BDProject_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public BDProject_CustomEntity() : base()
        {
        }
