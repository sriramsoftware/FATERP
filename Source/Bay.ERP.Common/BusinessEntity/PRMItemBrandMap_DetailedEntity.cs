...
{
    [Serializable]
    [DataContract(Name = "PRMItemBrandMap_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMItemBrandMap_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMItemBrandMap_DetailedEntity() : base()
        {
        }
