...
{
    [Serializable]
    [DataContract(Name = "PRMBOQDetail_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMBOQDetail_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMBOQDetail_CustomEntity() : base()
        {
        }
