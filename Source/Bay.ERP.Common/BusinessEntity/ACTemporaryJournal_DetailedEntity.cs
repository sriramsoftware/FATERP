...
{
    [Serializable]
    [DataContract(Name = "ACTemporaryJournal_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACTemporaryJournal_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        public ACTemporaryJournal_DetailedEntity() : base()
        {
        }
