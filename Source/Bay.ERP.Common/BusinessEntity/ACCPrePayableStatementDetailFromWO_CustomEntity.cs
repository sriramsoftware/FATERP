...
{
    [Serializable]
    [DataContract(Name = "ACCPrePayableStatementDetailFromWO_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACCPrePayableStatementDetailFromWO_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public ACCPrePayableStatementDetailFromWO_CustomEntity() : base()
        {
        }
