...
{
    [Serializable]
    [DataContract(Name = "ACProjectWiseAccount_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACProjectWiseAccount_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public ACProjectWiseAccount_CustomEntity() : base()
        {
        }
