...
{
    [Serializable]
    [DataContract(Name = "ResourceConsultant_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ResourceConsultant_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        private String _CMConsultantName;
        ...
        [DataMember]
        public String CMConsultantName
        {
            get { return _CMConsultantName; }
            set { _CMConsultantName = value; }
        }
        ...
        public ResourceConsultant_CustomEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_CMConsultantName = "CMConsultantName";
