...
{
    [Serializable]
    [DataContract(Name = "ACCPrePayableStatementDetailByBill_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class ACCPrePayableStatementDetailByBill_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public ACCPrePayableStatementDetailByBill_CustomEntity() : base()
        {
        }
