...
{
    [Serializable]
    [DataContract(Name = "PRMSupplierItemMapHistory_Custom", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class PRMSupplierItemMapHistory_CustomEntity : BaseEntity
    {
        #region Properties
        ...
        public PRMSupplierItemMapHistory_CustomEntity() : base()
        {
        }
