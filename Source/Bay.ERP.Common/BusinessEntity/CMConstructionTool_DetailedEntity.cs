...
{
    [Serializable]
    [DataContract(Name = "CMConstructionTool_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class CMConstructionTool_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        private String _ConstructionToolCategoryName;
        ...
        [DataMember]
        public String ConstructionToolCategoryName
        {
            get { return _ConstructionToolCategoryName; }
            set { _ConstructionToolCategoryName = value; }
        }
        ...
        public CMConstructionTool_DetailedEntity() : base()
        {
        }
        ...
        public const String FLD_NAME_ConstructionToolCategoryName = "ConstructionToolCategoryName";
