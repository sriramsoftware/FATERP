...
{
    [Serializable]
    [DataContract(Name = "INVTransactionAvailable_Detailed", Namespace = "http://www.e-p-m-s.com/types")]
    public partial class INVTransactionAvailable_DetailedEntity : BaseEntity
    {
        #region Properties
        ...
        public INVTransactionAvailable_DetailedEntity() : base()
        {
        }
