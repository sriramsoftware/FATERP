...
{    
    #region IACResourceBankAccountMapFacade

    [ServiceContract(Name = "IACResourceBankAccountMapFacade")]
    public partial interface IACResourceBankAccountMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACResourceBankAccountMapEntity GetByID(Int64 iD);
