...
{    
    #region IMDProjectAssignedPersonTeamRoleFacade

    [ServiceContract(Name = "IMDProjectAssignedPersonTeamRoleFacade")]
    public partial interface IMDProjectAssignedPersonTeamRoleFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDProjectAssignedPersonTeamRoleEntity GetByID(Int64 iD);
