...
{    
    #region IMDEmployeeSalaryPaymentStatusFacade

    [ServiceContract(Name = "IMDEmployeeSalaryPaymentStatusFacade")]
    public partial interface IMDEmployeeSalaryPaymentStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDEmployeeSalaryPaymentStatusEntity GetByID(Int64 iD);
