...
{    
    #region IINVStoreUnitFacade

    [ServiceContract(Name = "IINVStoreUnitFacade")]
    public partial interface IINVStoreUnitFacade : IDisposable
    {        
        ...
        [OperationContract]
        INVStoreUnitEntity GetByID(Int64 iD);
