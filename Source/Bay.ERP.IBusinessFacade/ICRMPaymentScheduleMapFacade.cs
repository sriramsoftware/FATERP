...
{    
    #region ICRMPaymentScheduleMapFacade

    [ServiceContract(Name = "ICRMPaymentScheduleMapFacade")]
    public partial interface ICRMPaymentScheduleMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        CRMPaymentScheduleMapEntity GetByID(Int64 iD);
