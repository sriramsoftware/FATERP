...
{    
    #region ICMMeasurementBookDetailFacade

    [ServiceContract(Name = "ICMMeasurementBookDetailFacade")]
    public partial interface ICMMeasurementBookDetailFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMMeasurementBookDetailEntity GetByID(Int64 iD);
