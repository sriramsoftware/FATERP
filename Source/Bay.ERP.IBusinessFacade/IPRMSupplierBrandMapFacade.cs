...
{    
    #region IPRMSupplierBrandMapFacade

    [ServiceContract(Name = "IPRMSupplierBrandMapFacade")]
    public partial interface IPRMSupplierBrandMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMSupplierBrandMapEntity GetByID(Int64 iD);
