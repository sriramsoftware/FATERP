...
{    
    #region IKBMDUserTreeSettingFacade

    [ServiceContract(Name = "IKBMDUserTreeSettingFacade")]
    public partial interface IKBMDUserTreeSettingFacade : IDisposable
    {        
        ...
        [OperationContract]
        KBMDUserTreeSettingEntity GetByID(Int64 iD);
