...
{    
    #region IACBankAccountTransferFacade

    [ServiceContract(Name = "IACBankAccountTransferFacade")]
    public partial interface IACBankAccountTransferFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACBankAccountTransferEntity GetByID(Int64 iD);
