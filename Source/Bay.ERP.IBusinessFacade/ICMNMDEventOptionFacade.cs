...
{    
    #region ICMNMDEventOptionFacade

    [ServiceContract(Name = "ICMNMDEventOptionFacade")]
    public partial interface ICMNMDEventOptionFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMNMDEventOptionEntity GetByID(Int64 iD);
