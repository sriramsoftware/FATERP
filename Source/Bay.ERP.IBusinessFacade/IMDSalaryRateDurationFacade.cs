...
{    
    #region IMDSalaryRateDurationFacade

    [ServiceContract(Name = "IMDSalaryRateDurationFacade")]
    public partial interface IMDSalaryRateDurationFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDSalaryRateDurationEntity GetByID(Int64 iD);
