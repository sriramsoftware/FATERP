...
{    
    #region IMDIssueAssignTypeFacade

    [ServiceContract(Name = "IMDIssueAssignTypeFacade")]
    public partial interface IMDIssueAssignTypeFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDIssueAssignTypeEntity GetByID(Int64 iD);
