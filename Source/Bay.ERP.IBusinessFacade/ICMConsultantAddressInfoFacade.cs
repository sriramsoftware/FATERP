...
{    
    #region ICMConsultantAddressInfoFacade

    [ServiceContract(Name = "ICMConsultantAddressInfoFacade")]
    public partial interface ICMConsultantAddressInfoFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMConsultantAddressInfoEntity GetByID(Int64 iD);
