...
{    
    #region ICMConsultantContactPersonFacade

    [ServiceContract(Name = "ICMConsultantContactPersonFacade")]
    public partial interface ICMConsultantContactPersonFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMConsultantContactPersonEntity GetByID(Int64 iD);
