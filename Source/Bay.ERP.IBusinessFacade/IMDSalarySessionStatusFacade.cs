...
{    
    #region IMDSalarySessionStatusFacade

    [ServiceContract(Name = "IMDSalarySessionStatusFacade")]
    public partial interface IMDSalarySessionStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDSalarySessionStatusEntity GetByID(Int64 iD);
