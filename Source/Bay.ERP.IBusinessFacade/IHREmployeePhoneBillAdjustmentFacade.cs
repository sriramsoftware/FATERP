...
{    
    ...
    [ServiceContract(Name = "IHREmployeePhoneBillAdjustmentFacade")]
    public partial interface IHREmployeePhoneBillAdjustmentFacade : IDisposable
    {        
        ...
        [OperationContract]
        HREmployeePhoneBillAdjustmentEntity GetByID(Int64 iD);
