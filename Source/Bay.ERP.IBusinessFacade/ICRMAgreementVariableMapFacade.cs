...
{    
    #region ICRMAgreementVariableMapFacade

    [ServiceContract(Name = "ICRMAgreementVariableMapFacade")]
    public partial interface ICRMAgreementVariableMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        CRMAgreementVariableMapEntity GetByID(Int64 iD);
