...
{    
    #region IHRAdditonalInformationFacade

    [ServiceContract(Name = "IHRAdditonalInformationFacade")]
    public partial interface IHRAdditonalInformationFacade : IDisposable
    {        
        ...
        [OperationContract]
        HRAdditonalInformationEntity GetByID(Int64 iD);
