...
{    
    #region IBDProjectUnitLocationFacade

    [ServiceContract(Name = "IBDProjectUnitLocationFacade")]
    public partial interface IBDProjectUnitLocationFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDProjectUnitLocationEntity GetByID(Int64 iD);
