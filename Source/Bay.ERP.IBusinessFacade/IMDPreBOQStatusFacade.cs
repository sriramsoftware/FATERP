...
{    
    #region IMDPreBOQStatusFacade

    [ServiceContract(Name = "IMDPreBOQStatusFacade")]
    public partial interface IMDPreBOQStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDPreBOQStatusEntity GetByID(Int64 iD);
