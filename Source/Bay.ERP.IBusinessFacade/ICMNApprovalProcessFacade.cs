...
{    
    #region ICMNApprovalProcessFacade

    [ServiceContract(Name = "ICMNApprovalProcessFacade")]
    public partial interface ICMNApprovalProcessFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMNApprovalProcessEntity GetByID(Int64 iD);
