...
{    
    #region IMDDocumentStorageTypeFacade

    [ServiceContract(Name = "IMDDocumentStorageTypeFacade")]
    public partial interface IMDDocumentStorageTypeFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDDocumentStorageTypeEntity GetByID(Int64 iD);
