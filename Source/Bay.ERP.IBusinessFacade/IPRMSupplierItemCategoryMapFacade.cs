...
{    
    #region IPRMSupplierItemCategoryMapFacade

    [ServiceContract(Name = "IPRMSupplierItemCategoryMapFacade")]
    public partial interface IPRMSupplierItemCategoryMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMSupplierItemCategoryMapEntity GetByID(Int64 iD);
