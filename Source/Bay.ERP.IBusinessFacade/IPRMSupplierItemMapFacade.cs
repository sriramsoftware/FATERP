...
{    
    #region IPRMSupplierItemMapFacade

    [ServiceContract(Name = "IPRMSupplierItemMapFacade")]
    public partial interface IPRMSupplierItemMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMSupplierItemMapEntity GetByID(Int64 iD);
