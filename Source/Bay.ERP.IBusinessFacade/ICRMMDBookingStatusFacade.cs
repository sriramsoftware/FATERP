...
{    
    #region ICRMMDBookingStatusFacade

    [ServiceContract(Name = "ICRMMDBookingStatusFacade")]
    public partial interface ICRMMDBookingStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        CRMMDBookingStatusEntity GetByID(Int64 iD);
