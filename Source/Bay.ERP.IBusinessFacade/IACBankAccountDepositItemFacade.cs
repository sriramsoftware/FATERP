...
{    
    #region IACBankAccountDepositItemFacade

    [ServiceContract(Name = "IACBankAccountDepositItemFacade")]
    public partial interface IACBankAccountDepositItemFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACBankAccountDepositItemEntity GetByID(Int64 iD);
