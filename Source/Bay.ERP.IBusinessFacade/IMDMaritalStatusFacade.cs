...
{    
    #region IMDMaritalStatusFacade

    [ServiceContract(Name = "IMDMaritalStatusFacade")]
    public partial interface IMDMaritalStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDMaritalStatusEntity GetByID(Int64 iD);
