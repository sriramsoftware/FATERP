...
{    
    #region IINVStoreIssueNoteFacade

    [ServiceContract(Name = "IINVStoreIssueNoteFacade")]
    public partial interface IINVStoreIssueNoteFacade : IDisposable
    {        
        ...
        [OperationContract]
        INVStoreIssueNoteEntity GetByID(Int64 iD);
