...
{    
    #region IBDProjectFloorUnitFacade

    [ServiceContract(Name = "IBDProjectFloorUnitFacade")]
    public partial interface IBDProjectFloorUnitFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDProjectFloorUnitEntity GetByID(Int64 iD);
