...
{    
    #region ICRMLandBasicInfoFacade

    [ServiceContract(Name = "ICRMLandBasicInfoFacade")]
    public partial interface ICRMLandBasicInfoFacade : IDisposable
    {        
        ...
        [OperationContract]
        CRMLandBasicInfoEntity GetByID(Int64 iD);
