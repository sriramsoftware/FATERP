...
{    
    #region IHREmployeeMonthlyTimeSheetSummaryFacade

    [ServiceContract(Name = "IHREmployeeMonthlyTimeSheetSummaryFacade")]
    public partial interface IHREmployeeMonthlyTimeSheetSummaryFacade : IDisposable
    {        
        ...
        [OperationContract]
        HREmployeeMonthlyTimeSheetSummaryEntity GetByID(Int64 iD);
