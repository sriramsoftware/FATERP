...
{    
    #region IMDDocumentCategoryFacade

    [ServiceContract(Name = "IMDDocumentCategoryFacade")]
    public partial interface IMDDocumentCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDDocumentCategoryEntity GetByID(Int64 iD);
