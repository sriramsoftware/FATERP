...
{    
    #region IAPPanelMemberFacade

    [ServiceContract(Name = "IAPPanelMemberFacade")]
    public partial interface IAPPanelMemberFacade : IDisposable
    {        
        ...
        [OperationContract]
        APPanelMemberEntity GetByID(Int64 iD);
