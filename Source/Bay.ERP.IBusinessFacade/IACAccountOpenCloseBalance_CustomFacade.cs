...
{    
    #region IACAccountOpenCloseBalance_CustomFacade

    [ServiceContract(Name = "IACAccountOpenCloseBalance_CustomFacade")]
    public partial interface IACAccountOpenCloseBalance_CustomFacade : IDisposable
    {
        #region Get
