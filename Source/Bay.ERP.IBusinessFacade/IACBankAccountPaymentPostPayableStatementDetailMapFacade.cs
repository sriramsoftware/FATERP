...
{    
    #region IACBankAccountPaymentPostPayableStatementDetailMapFacade

    [ServiceContract(Name = "IACBankAccountPaymentPostPayableStatementDetailMapFacade")]
    public partial interface IACBankAccountPaymentPostPayableStatementDetailMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACBankAccountPaymentPostPayableStatementDetailMapEntity GetByID(Int64 iD);
