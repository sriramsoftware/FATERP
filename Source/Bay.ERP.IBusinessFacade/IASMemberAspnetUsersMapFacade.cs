...
{    
    ...
    [ServiceContract(Name = "IASMemberAspnetUsersMapFacade")]
    public partial interface IASMemberAspnetUsersMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        ASMemberAspnetUsersMapEntity GetByID(Int64 iD);
