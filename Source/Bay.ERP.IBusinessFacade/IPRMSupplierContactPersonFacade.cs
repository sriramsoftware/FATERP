...
{    
    #region IPRMSupplierContactPersonFacade

    [ServiceContract(Name = "IPRMSupplierContactPersonFacade")]
    public partial interface IPRMSupplierContactPersonFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMSupplierContactPersonEntity GetByID(Int64 iD);
