...
{    
    #region ICMBillRequisitionItemMapFacade

    [ServiceContract(Name = "ICMBillRequisitionItemMapFacade")]
    public partial interface ICMBillRequisitionItemMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMBillRequisitionItemMapEntity GetByID(Int64 iD);
