...
{    
    #region IREQRequisitionWithWorkOrder_CustomFacade

    [ServiceContract(Name = "IREQRequisitionWithWorkOrder_CustomFacade")]
    public partial interface IREQRequisitionWithWorkOrder_CustomFacade : IDisposable
    {
        #region Get
