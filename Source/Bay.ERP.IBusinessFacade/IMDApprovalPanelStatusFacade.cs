...
{    
    #region IMDApprovalPanelStatusFacade

    [ServiceContract(Name = "IMDApprovalPanelStatusFacade")]
    public partial interface IMDApprovalPanelStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDApprovalPanelStatusEntity GetByID(Int64 iD);
