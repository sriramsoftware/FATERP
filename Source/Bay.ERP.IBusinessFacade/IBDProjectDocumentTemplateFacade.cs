...
{    
    #region IBDProjectDocumentTemplateFacade

    [ServiceContract(Name = "IBDProjectDocumentTemplateFacade")]
    public partial interface IBDProjectDocumentTemplateFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDProjectDocumentTemplateEntity GetByID(Int64 iD);
