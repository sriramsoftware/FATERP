...
{    
    #region IACAccountStatusFacade

    [ServiceContract(Name = "IACAccountStatusFacade")]
    public partial interface IACAccountStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACAccountStatusEntity GetByID(Int64 iD);
