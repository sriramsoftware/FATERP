...
{    
    #region IACTemporaryJournal_DetailedFacade

    [ServiceContract(Name = "IACTemporaryJournal_DetailedFacade")]
    public partial interface IACTemporaryJournal_DetailedFacade : IDisposable
    {
        #region Get
