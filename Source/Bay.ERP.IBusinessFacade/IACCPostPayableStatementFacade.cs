...
{    
    #region IACCPostPayableStatementFacade

    [ServiceContract(Name = "IACCPostPayableStatementFacade")]
    public partial interface IACCPostPayableStatementFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACCPostPayableStatementEntity GetByID(Int64 iD);
