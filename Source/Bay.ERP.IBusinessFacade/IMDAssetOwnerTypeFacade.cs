...
{    
    #region IMDAssetOwnerTypeFacade

    [ServiceContract(Name = "IMDAssetOwnerTypeFacade")]
    public partial interface IMDAssetOwnerTypeFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDAssetOwnerTypeEntity GetByID(Int64 iD);
