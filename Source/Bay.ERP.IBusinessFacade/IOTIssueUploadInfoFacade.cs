...
{    
    #region IOTIssueUploadInfoFacade

    [ServiceContract(Name = "IOTIssueUploadInfoFacade")]
    public partial interface IOTIssueUploadInfoFacade : IDisposable
    {        
        ...
        [OperationContract]
        OTIssueUploadInfoEntity GetByID(Int64 iD);
