...
{    
    #region IMDProjectDocumentFacade

    [ServiceContract(Name = "IMDProjectDocumentFacade")]
    public partial interface IMDProjectDocumentFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDProjectDocumentEntity GetByID(Int64 iD);
