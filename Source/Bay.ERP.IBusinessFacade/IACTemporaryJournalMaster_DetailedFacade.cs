...
{    
    #region IACTemporaryJournalMaster_DetailedFacade

    [ServiceContract(Name = "IACTemporaryJournalMaster_DetailedFacade")]
    public partial interface IACTemporaryJournalMaster_DetailedFacade : IDisposable
    {
        #region Get
