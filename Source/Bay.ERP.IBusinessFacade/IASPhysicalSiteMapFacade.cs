...
{    
    #region IASPhysicalSiteMapFacade

    [ServiceContract(Name = "IASPhysicalSiteMapFacade")]
    public partial interface IASPhysicalSiteMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        ASPhysicalSiteMapEntity GetByID(Int64 iD);
