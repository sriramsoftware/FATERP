...
{    
    #region IPRMPreBOQTemplateFacade

    [ServiceContract(Name = "IPRMPreBOQTemplateFacade")]
    public partial interface IPRMPreBOQTemplateFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMPreBOQTemplateEntity GetByID(Int64 iD);
