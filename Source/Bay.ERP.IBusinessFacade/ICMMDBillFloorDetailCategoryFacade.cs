...
{    
    #region ICMMDBillFloorDetailCategoryFacade

    [ServiceContract(Name = "ICMMDBillFloorDetailCategoryFacade")]
    public partial interface ICMMDBillFloorDetailCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMMDBillFloorDetailCategoryEntity GetByID(Int64 iD);
