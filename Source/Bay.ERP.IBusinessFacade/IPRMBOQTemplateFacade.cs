...
{    
    #region IPRMBOQTemplateFacade

    [ServiceContract(Name = "IPRMBOQTemplateFacade")]
    public partial interface IPRMBOQTemplateFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMBOQTemplateEntity GetByID(Int64 iD);
