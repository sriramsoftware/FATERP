...
{    
    #region IPRMWorkOrderPaymentTermFacade

    [ServiceContract(Name = "IPRMWorkOrderPaymentTermFacade")]
    public partial interface IPRMWorkOrderPaymentTermFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMWorkOrderPaymentTermEntity GetByID(Int64 iD);
