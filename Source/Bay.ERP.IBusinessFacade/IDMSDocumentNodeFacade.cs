...
{    
    #region IDMSDocumentNodeFacade

    [ServiceContract(Name = "IDMSDocumentNodeFacade")]
    public partial interface IDMSDocumentNodeFacade : IDisposable
    {        
        ...
        [OperationContract]
        DMSDocumentNodeEntity GetByID(Int64 iD);
