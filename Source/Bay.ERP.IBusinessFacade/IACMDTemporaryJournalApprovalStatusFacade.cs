...
{    
    #region IACMDTemporaryJournalApprovalStatusFacade

    [ServiceContract(Name = "IACMDTemporaryJournalApprovalStatusFacade")]
    public partial interface IACMDTemporaryJournalApprovalStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACMDTemporaryJournalApprovalStatusEntity GetByID(Int64 iD);
