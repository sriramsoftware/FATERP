...
{    
    #region ICMCriterionStatusRemarks_DetailedFacade

    [ServiceContract(Name = "ICMCriterionStatusRemarks_DetailedFacade")]
    public partial interface ICMCriterionStatusRemarks_DetailedFacade : IDisposable
    {
        #region Get
