...
{    
    #region IMDMailTemplateTypeFacade

    [ServiceContract(Name = "IMDMailTemplateTypeFacade")]
    public partial interface IMDMailTemplateTypeFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDMailTemplateTypeEntity GetByID(Int64 iD);
