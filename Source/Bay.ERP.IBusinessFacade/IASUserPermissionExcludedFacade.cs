...
{    
    ...
    [ServiceContract(Name = "IASUserPermissionExcludedFacade")]
    public partial interface IASUserPermissionExcludedFacade : IDisposable
    {        
        ...
        [OperationContract]
        ASUserPermissionExcludedEntity GetByID(Int64 iD);
