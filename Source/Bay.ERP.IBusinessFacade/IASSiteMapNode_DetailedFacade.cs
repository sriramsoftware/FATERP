...
{    
    #region IASSiteMapNode_DetailedFacade

    [ServiceContract(Name = "IASSiteMapNode_DetailedFacade")]
    public partial interface IASSiteMapNode_DetailedFacade : IDisposable
    {
        #region Get
