...
{    
    #region IBDMDTaskCategoryFacade

    [ServiceContract(Name = "IBDMDTaskCategoryFacade")]
    public partial interface IBDMDTaskCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDMDTaskCategoryEntity GetByID(Int64 iD);
