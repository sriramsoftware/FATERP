...
{    
    #region IMDWorkOrderStatusFacade

    [ServiceContract(Name = "IMDWorkOrderStatusFacade")]
    public partial interface IMDWorkOrderStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDWorkOrderStatusEntity GetByID(Int64 iD);
