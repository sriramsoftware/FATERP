...
{    
    #region IAPPanelForwardMemberFacade

    [ServiceContract(Name = "IAPPanelForwardMemberFacade")]
    public partial interface IAPPanelForwardMemberFacade : IDisposable
    {        
        ...
        [OperationContract]
        APPanelForwardMemberEntity GetByID(Int64 iD);
