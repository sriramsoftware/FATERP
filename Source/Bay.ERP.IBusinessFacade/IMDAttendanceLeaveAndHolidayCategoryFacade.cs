...
{    
    #region IMDAttendanceLeaveAndHolidayCategoryFacade

    [ServiceContract(Name = "IMDAttendanceLeaveAndHolidayCategoryFacade")]
    public partial interface IMDAttendanceLeaveAndHolidayCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDAttendanceLeaveAndHolidayCategoryEntity GetByID(Int64 iD);
