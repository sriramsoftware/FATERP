...
{    
    #region IBDProjectParkingFacade

    [ServiceContract(Name = "IBDProjectParkingFacade")]
    public partial interface IBDProjectParkingFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDProjectParkingEntity GetByID(Int64 iD);
