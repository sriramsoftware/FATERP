...
{    
    #region IMDEvaluationCriteriaCategoryFacade

    [ServiceContract(Name = "IMDEvaluationCriteriaCategoryFacade")]
    public partial interface IMDEvaluationCriteriaCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDEvaluationCriteriaCategoryEntity GetByID(Int64 iD);
