...
{    
    #region IMDSupplierStatusFacade

    [ServiceContract(Name = "IMDSupplierStatusFacade")]
    public partial interface IMDSupplierStatusFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDSupplierStatusEntity GetByID(Int64 iD);
