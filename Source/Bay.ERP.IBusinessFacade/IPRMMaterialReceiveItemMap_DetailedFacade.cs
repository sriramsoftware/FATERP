...
{    
    #region IPRMMaterialReceiveItemMap_DetailedFacade

    [ServiceContract(Name = "IPRMMaterialReceiveItemMap_DetailedFacade")]
    public partial interface IPRMMaterialReceiveItemMap_DetailedFacade : IDisposable
    {
        #region Get
