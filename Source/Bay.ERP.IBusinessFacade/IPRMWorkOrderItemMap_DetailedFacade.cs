...
{    
    #region IPRMWorkOrderItemMap_DetailedFacade

    [ServiceContract(Name = "IPRMWorkOrderItemMap_DetailedFacade")]
    public partial interface IPRMWorkOrderItemMap_DetailedFacade : IDisposable
    {
        #region Get
