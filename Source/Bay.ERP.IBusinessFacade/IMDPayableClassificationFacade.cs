...
{    
    #region IMDPayableClassificationFacade

    [ServiceContract(Name = "IMDPayableClassificationFacade")]
    public partial interface IMDPayableClassificationFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDPayableClassificationEntity GetByID(Int64 iD);
