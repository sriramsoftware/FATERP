...
{    
    #region IBDMDTaskRepeatFacade

    [ServiceContract(Name = "IBDMDTaskRepeatFacade")]
    public partial interface IBDMDTaskRepeatFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDMDTaskRepeatEntity GetByID(Int64 iD);
