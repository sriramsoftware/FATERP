...
{    
    #region IHREmployeeMonthlyTimeSheetFacade

    [ServiceContract(Name = "IHREmployeeMonthlyTimeSheetFacade")]
    public partial interface IHREmployeeMonthlyTimeSheetFacade : IDisposable
    {        
        ...
        [OperationContract]
        HREmployeeMonthlyTimeSheetEntity GetByID(Int64 iD);
