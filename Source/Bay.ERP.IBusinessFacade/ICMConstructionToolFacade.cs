...
{    
    #region ICMConstructionToolFacade

    [ServiceContract(Name = "ICMConstructionToolFacade")]
    public partial interface ICMConstructionToolFacade : IDisposable
    {        
        ...
        [OperationContract]
        CMConstructionToolEntity GetByID(Int64 iD);
