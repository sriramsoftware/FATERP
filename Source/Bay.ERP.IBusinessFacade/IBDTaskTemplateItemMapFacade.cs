...
{    
    #region IBDTaskTemplateItemMapFacade

    [ServiceContract(Name = "IBDTaskTemplateItemMapFacade")]
    public partial interface IBDTaskTemplateItemMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDTaskTemplateItemMapEntity GetByID(Int64 iD);
