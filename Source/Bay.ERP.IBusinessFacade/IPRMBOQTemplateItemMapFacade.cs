...
{    
    #region IPRMBOQTemplateItemMapFacade

    [ServiceContract(Name = "IPRMBOQTemplateItemMapFacade")]
    public partial interface IPRMBOQTemplateItemMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        PRMBOQTemplateItemMapEntity GetByID(Int64 iD);
