...
{    
    #region IACBankAccountTransfer_DetailedFacade

    [ServiceContract(Name = "IACBankAccountTransfer_DetailedFacade")]
    public partial interface IACBankAccountTransfer_DetailedFacade : IDisposable
    {
        #region Get
