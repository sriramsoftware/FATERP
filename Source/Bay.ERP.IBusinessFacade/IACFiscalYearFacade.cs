...
{    
    #region IACFiscalYearFacade

    [ServiceContract(Name = "IACFiscalYearFacade")]
    public partial interface IACFiscalYearFacade : IDisposable
    {        
        ...
        [OperationContract]
        ACFiscalYearEntity GetByID(Int64 iD);
