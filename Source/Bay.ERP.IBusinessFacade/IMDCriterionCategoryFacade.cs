...
{    
    #region IMDCriterionCategoryFacade

    [ServiceContract(Name = "IMDCriterionCategoryFacade")]
    public partial interface IMDCriterionCategoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        MDCriterionCategoryEntity GetByID(Int64 iD);
