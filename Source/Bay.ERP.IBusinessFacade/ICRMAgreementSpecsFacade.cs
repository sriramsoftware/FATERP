...
{    
    #region ICRMAgreementSpecsFacade

    [ServiceContract(Name = "ICRMAgreementSpecsFacade")]
    public partial interface ICRMAgreementSpecsFacade : IDisposable
    {        
        ...
        [OperationContract]
        CRMAgreementSpecsEntity GetByID(Int64 iD);
