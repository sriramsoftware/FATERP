...
{    
    #region IBDProjectHistoryFacade

    [ServiceContract(Name = "IBDProjectHistoryFacade")]
    public partial interface IBDProjectHistoryFacade : IDisposable
    {        
        ...
        [OperationContract]
        BDProjectHistoryEntity GetByID(Int64 iD);
