...
{    
    #region IHREmployeeSupervisorMapFacade

    [ServiceContract(Name = "IHREmployeeSupervisorMapFacade")]
    public partial interface IHREmployeeSupervisorMapFacade : IDisposable
    {        
        ...
        [OperationContract]
        HREmployeeSupervisorMapEntity GetByID(Int64 iD);
