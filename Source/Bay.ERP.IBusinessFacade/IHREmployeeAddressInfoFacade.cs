...
{    
    #region IHREmployeeAddressInfoFacade

    [ServiceContract(Name = "IHREmployeeAddressInfoFacade")]
    public partial interface IHREmployeeAddressInfoFacade : IDisposable
    {        
        ...
        [OperationContract]
        HREmployeeAddressInfoEntity GetByID(Int64 iD);
