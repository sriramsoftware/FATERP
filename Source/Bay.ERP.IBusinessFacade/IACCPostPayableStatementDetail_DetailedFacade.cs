...
{    
    #region IACCPostPayableStatementDetail_DetailedFacade

    [ServiceContract(Name = "IACCPostPayableStatementDetail_DetailedFacade")]
    public partial interface IACCPostPayableStatementDetail_DetailedFacade : IDisposable
    {
        #region Get
