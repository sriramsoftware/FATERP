...
{
    public sealed partial class MDItemCategoryFacade : IMDItemCategoryFacade
    {
        ...
        [OperationContract]
        IList<Int64> IMDItemCategoryFacade.Update(IList<MDItemCategoryEntity> mDItemCategoryEntityList, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran)
        {
            return DataAccessFactory.CreateMDItemCategoryDataAccess().Update(mDItemCategoryEntityList, filterExpression, option, reqTran);
        }
        ...
        [OperationContract]
        IList<MDItemCategoryEntity> IMDItemCategoryFacade.GetIL(Int32? currentPage, Int32? pageSize, String sortExpression, String filterExpression, DatabaseOperationType option)
        {
            return DataAccessFactory.CreateMDItemCategoryDataAccess().GetIL(currentPage, pageSize, sortExpression, filterExpression, option);
        }

        [OperationContract]
        DataTable IMDItemCategoryFacade.GetDT(Int32? currentPage, Int32? pageSize, String sortExpression, String filterExpression, DatabaseOperationType option)
        {
            return DataAccessFactory.CreateMDItemCategoryDataAccess().GetDT(currentPage, pageSize, sortExpression, filterExpression, option);
        }
