...
{
    #region IHREmployeeDetailsForMonthlyTimeSheetSummary_CustomDataAccess

    public partial interface IHREmployeeDetailsForMonthlyTimeSheetSummary_CustomDataAccess
    {
        #region Get
