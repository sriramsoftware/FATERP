...
{
    #region ICRMSurveyDataAccess

    public partial interface ICRMSurveyMasterDataAccess
    {
        ...
        IList<Int64> Add(IList<CRMSurveyMasterEntity> cRMSurveyMasterEntityList, DatabaseOperationType option, TransactionRequired reqTran);

        IList<Int64> Update(IList<CRMSurveyMasterEntity> cRMSurveyMasterEntityList, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran);

        IList<Int64> Delete(IList<CRMSurveyMasterEntity> cRMSurveyMasterEntityList, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran);
