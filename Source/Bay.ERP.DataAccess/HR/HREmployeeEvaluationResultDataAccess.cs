...
{
    internal sealed partial class HREmployeeEvaluationResultDataAccess : BaseDataAccess, IHREmployeeEvaluationResultDataAccess
    {
        #region Constructors

        public HREmployeeEvaluationResultDataAccess(Context context)
            : base(context)
        {
        }

        protected override IEntityBuilder<HREmployeeEvaluationResultEntity> CreateEntityBuilder<HREmployeeEvaluationResultEntity>()
        {
            return (new HREmployeeEvaluationResultBuilder()) as IEntityBuilder<HREmployeeEvaluationResultEntity>;
        }
        ...
        private Int64 Add(HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity, DatabaseOperationType option)
        {
            long returnCode = -99;
            ...
            using (DbCommand cmd = Database.GetStoredProcCommand(SP))
            {
                ...
                AddNullPrimaryKeyParameter(cmd, "EmployeeEvaluationResultID");
        ...
        private Int64 AddTran(HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity, DatabaseOperationType option)
        {
            long returnCode = -99;
            const string SP = "dbo.HREmployeeEvaluationResult_SET";
            ...
            using (DbCommand cmd = db.GetStoredProcCommand(SP))
            {
                ...
                AddNullPrimaryKeyParameter(cmd, "EmployeeEvaluationResultID", db);
        ...
        IList<Int64> IHREmployeeEvaluationResultDataAccess.Add(IList<HREmployeeEvaluationResultEntity> hREmployeeEvaluationResultEntityList, DatabaseOperationType option, TransactionRequired reqTran)
        {
            IList<Int64> returnCodeList = new List<Int64>(); 

            long returnCode = -99; 

            foreach (HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity in hREmployeeEvaluationResultEntityList)
            {
                returnCode = (this as IHREmployeeEvaluationResultDataAccess).Add(hREmployeeEvaluationResultEntity, option, reqTran); 
        ...
        Int64 IHREmployeeEvaluationResultDataAccess.Update(HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran)
        {
            try
            {
                long retValues = -99;
                ...
                switch (reqTran)
                {
                    case TransactionRequired.No:
                        {
                            retValues = Update(hREmployeeEvaluationResultEntity, filterExpression, option);
                            break;
                        }
                    case TransactionRequired.Yes:
                        {
                            retValues = UpdateTran(hREmployeeEvaluationResultEntity, filterExpression, option);
                            break;
                        }
                    default:
                        {
        ...
        IList<Int64> IHREmployeeEvaluationResultDataAccess.Update(IList<HREmployeeEvaluationResultEntity> hREmployeeEvaluationResultEntityList, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran)
        {
            IList<Int64> returnCodeList = new List<Int64>(); 
            ...
            foreach (HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity in hREmployeeEvaluationResultEntityList)
            {
                returnCode = (this as IHREmployeeEvaluationResultDataAccess).Update(hREmployeeEvaluationResultEntity, filterExpression, option, reqTran);
        ...
        Int64 IHREmployeeEvaluationResultDataAccess.Delete(HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran)
        {
            try
            {
                long retValues = -99;
                ...
                switch (reqTran)
                {
                    case TransactionRequired.No:
                        {
                            retValues = Delete(hREmployeeEvaluationResultEntity, filterExpression, option);
                            break;
                        }
                    case TransactionRequired.Yes:
                        {
                            retValues = DeleteTran(hREmployeeEvaluationResultEntity, filterExpression, option);
                            break;
                        }
                    default:
                        {
        ...
        IList<Int64> IHREmployeeEvaluationResultDataAccess.Delete(IList<HREmployeeEvaluationResultEntity> hREmployeeEvaluationResultEntityList, String filterExpression, DatabaseOperationType option, TransactionRequired reqTran)
        {
            IList<Int64> returnCodeList = new List<Int64>(); 
            ...
            foreach (HREmployeeEvaluationResultEntity hREmployeeEvaluationResultEntity in hREmployeeEvaluationResultEntityList)
            {
                returnCode = (this as IHREmployeeEvaluationResultDataAccess).Delete(hREmployeeEvaluationResultEntity, filterExpression, option, reqTran);
        ...
        IList<HREmployeeEvaluationResultEntity> IHREmployeeEvaluationResultDataAccess.GetIL(Int32? currentPage, Int32? pageSize, String sortExpression, String filterExpression, DatabaseOperationType option)
        {
            try
            {
                const string SP = "dbo.HREmployeeEvaluationResult_GET";
                ...
                using (DbCommand cmd = Database.GetStoredProcCommand(SP))
                {
                    ...
                    using (IDataReader reader = Database.ExecuteReader(cmd))
                    {
                        IList<HREmployeeEvaluationResultEntity> list = CreateEntityBuilder<HREmployeeEvaluationResultEntity>().BuildEntities(reader);
        ...
        DataTable IHREmployeeEvaluationResultDataAccess.GetDT(Int32? currentPage, Int32? pageSize, String sortExpression, String filterExpression, DatabaseOperationType option)
        {
            try
            {
                const string SP = "dbo.HREmployeeEvaluationResult_GET";
